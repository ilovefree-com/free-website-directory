...
> Free image editors, online design tools, stock photos, 3D models, photography tools, and image creation resources curated by the FMHY community.

### Image Editing

-   [Canvas](https://www.nvidia.com/en-us/studio/creative-side-hustle/) - Turn Simple Art into Photorealistic Landscapes
-   [Croppola](https://croppola.com/) - Cropping Tools
...
-   [Scribus](https://www.scribus.net/) - Page Layout & Typesetting Programs
...
-   [Pixlr](https://pixlr.com/) - Simple Editor / Hide Premium / Unlimited Saves, 2
...
-   [MiNi Photo Editor](https://mini2-photo-editor.netlify.app/) - Simple Editor
...
-   [BG Bye](https://bgbye.io/) - Background Remover
-   [ObjectRemover](https://objectremover.com/) - Object Removers
...
-   [remove.bg](https://www.remove.bg/) - Background Remover / GIMP Plugin
-   [Ripolas Background Remover](https://ripolas.org/background-remover/) - Background Remover / Non-AI
-   [Segment Anything](https://aidemos.meta.com/segment-anything) - Visual Segmentation / GUI / Stable Diffusion WebUI / Extensions

#### Upscale / Restore

-   [chaiNNer](https://chainner.app/) - Image Upscaling / Self-Hosted
...
-   [Upscayl](https://upscayl.org/) - Image Upscaling / Self-Hosted
-   [Waifu2x](https://github.com/nagadomi/nunif) - Anime Image Upscaling / WebUI, 2, 3 / Self-Hosted
...
-   [Ilaria\_Upscaler](https://huggingface.co/spaces/TheStinger/Ilaria_Upscaler) - Image Upscaling / Online
...
-   [Real-ESRGAN](https://github.com/xinntao/Real-ESRGAN) - Image Restoration Algorithms / Face Restoration / Online / Self-Hosted
...
-   [Mosh](https://moshpro.app/) - Glitch Images
...
-   [ordered-dither-maker](https://seleb.github.io/ordered-dither-maker/) - Image Dithering / Bitmap Generators
-   [Palettum](https://palettum.com/) - Add Custom Color Palettes to Images & GIFs
-   [Party-ify](https://nathanielw.github.io/party-ify/) - Party-ify Images
-   [PBNify](https://pbnify.com/) - Paint by Number Tool
-   [PhotoFunia](https://photofunia.com/) - Photo Effects / Filters
-   [PhotoJoiner](https://www.photojoiner.com/) - Collage Makers / Editors
-   [Rutt-Etra-Izer](https://airtightinteractive.com/demos/js/ruttetra/) - Scanned-line Images
-   [⁠shabzefilters](https://shabzefilters.netlify.app/) - Image to ASCII Art
...
-   [Krita](https://krita.org/en/) - Painting App / / AI Generation
-   [miniPaint](https://viliusle.github.io/miniPaint/) - Browser Painting
-   [Pinta](https://www.pinta-project.com/) - Painting App
...
-   [Fresco](https://www.adobe.com/products/fresco.html) - Drawing
-   [Graphite](https://graphite.art/) - Vector Editor
-   [HeavyPaint](https://www.heavypaint.com/) - Water Color Painting
-   [Inkscape](https://inkscape.org/) - Drawing / Sketching
-   [Inscribed](https://inscribed.app/) - Sketch-Based Slides
-   [IOGraphica](https://iographica.com/) - Turn Mouse Movement into Art
-   [Kleki](https://kleki.com/) - Drawing / Sketching
-   [KRESKA.art](https://kreska.art/) - Browser Painting / Drawing
-   [Magma](https://magma.com/) - Collaborative Drawing
...
-   [PixiEditor](https://pixieditor.net/) - Vector Editor / Painting App
-   [⁠Provector](https://start.provector.app/) - Vector Editor
...
-   [SumoPaint](https://sumopaint.com/) - Browser Painting
-   [Tilda](https://tilda.cc/lp/vector/) - Vector Editor
-   [tldraw](https://www.tldraw.com/) - Drawing / Sketching
-   [VectorPaint](https://vectorpaint.yaks.co.nz/) - Vector Editor / Painting
-   [⁠Vectorpea](https://www.vectorpea.com/) - Vector Editor
...
-   [Aseprite](https://github.com/aseprite/aseprite) - Pixel Art Editor / Guide
...
-   [GB Dot Converter](https://deepblizzard.itch.io/gb-dot-converter) - Image to Game Boy Style Art Converter
-   [GIF to Frames](https://giftoframes.com/) - GIF to Spritesheet
-   [⁠GLORP](https://zack-gphom.itch.io/glorp-pixel-to-svg) - Convert Pixel Art to Optimized SVGs
...
-   [⁠Poxil](https://poxil.vercel.app/) - Pixel Art Editor
-   [PyDPainter](https://pydpainter.org/) - Bitmap Graphics Editor
-   [rx](https://rx.cloudhead.io/) - Pixel Art Editor
-   [SpookyGhost](https://encelo.itch.io/spookyghost) - Pixel Art Editor

#### GIF Tools

-   [EZGif](https://ezgif.com/) - GIF Generators
-   [Gifski](https://gif.ski/) - GIF Encoder
-   [⁠AnimGifMoji](https://www.animgifmoji.com/) - GIF to Emoji Converter
-   [blinkies.cafe](https://blinkies.cafe/) - Custom Retro Blinkie GIFs / Badges
-   [DrawIsland](https://drawisland.com/) - Create GIFs from Drawings
-   [Gifsicle](http://www.lcdf.org/gifsicle/) - GIF Generator
-   [Giphy](https://giphy.com/) - View / Download GIFs
-   [licecap](https://www.cockos.com/licecap/) - Create GIFs via Screencasts
-   [⁠MakeEmoji](https://makeemoji.com/) - Make Custom Animated Emojis
-   [⁠PicMix](https://www.picmix.com/) - Glitter Style GIF Creator
-   [ScreenToGif](https://www.screentogif.com/) - GIF Recorder
-   [ugiffer](https://iobureau.com/ugiffer/) - Create GIFs via Screencasts

#### Meme Tools

-   [Know Your Meme](https://knowyourmeme.com/) - Meme Databases
...
-   [ImgFlip](https://imgflip.com/memegenerator) - Meme Creators
...
-   [Muzli](https://search.muz.li/) - Design Inspiration Sites
...
-   [blush](https://blush.design/) - Illustration Design
-   [Canva](https://www.canva.com/) - Design App / / Invites
-   [lunacy](https://icons8.com/lunacy) - Design App
-   [Pattern Ninja](https://patterninja.com/) - Background / Pattern Design
-   [Penpot](https://penpot.app/) - Design App & Prototyping Platform
...
-   [⁠FreeLogoMaker](https://myfreelogomaker.com/) - Logo Creators
-   [⁠Icon Gen](https://icon-gen.netlify.app/) - Logo to Avatar / Icon Generator
-   [⁠Icon Z](https://icon-z.com/) - Simple Face Avatar Creators
-   [Innocenzi](https://avatar.innocenzi.dev/) - Round Avatar Creator
-   [Logo Fast](https://logofa.st/) - Simple Logo Creators Based on Premade Icons
...
-   [PixelMe](https://xsgames.co/pixelme/) - 8-bit Avatar Creators
...
-   [Worldvectorlogo](https://worldvectorlogo.com/) - Logo Search / Designs
...
-   [DoodDad](https://doodad.dev/pattern-generator) - Pattern Generators
...
-   [Noise & Gradient](https://www.noiseandgradient.com/) - Background / Gradient Generators
-   [⁠Normal Map Generator](https://normalmapgenerator.art/) - 2D to 3D Texture Map Converter
-   [Pixela](https://pixela.ai/) - Texture Generators
-   [Subtle Patterns](https://www.toptal.com/designers/subtlepatterns/) - Patterns
-   [Tabbied](https://tabbied.com/) - Art Pattern Generators
...
-   [all\_psd](https://vk.com/all_psd)
-   [AvaxGFX](https://avxgfx.com/)
-   [Cg\_peers Archive](https://t.me/Cgpeers_archive)
...
-   [Free\_Design\_Files](https://t.me/Free_Design_Files)
...
-   [PanosFX](https://www.panosfx.com/) - Photoshop Actions
...
-   [PixelJoint](https://pixeljoint.com/) - Download / Share Pixel Art
...
-   [shot.cafe](https://shot.cafe/) - Media Screenshots / Stills

#### Image Search Engines

-   [SauceNao](https://saucenao.com/) - Reverse Image Search / Extension
...
-   [TinEye](https://tineye.com/) - Reverse Image Search / Extension
...
-   [MaxURL](https://qsniyg.github.io/maxurl/) - Larger Image Search
-   [Multicolr](https://labs.tineye.com/multicolr/) - Color-Based Image Search
-   [Pose Search](https://x6ud.github.io/pose-search/) - Pose Reference Image Search
...
-   [EveryPixel](https://www.everypixel.com/) - Stock Photo Search Engines
-   [GetPaidStock](https://getpaidstock.com/) - Paid Stock Photo Downloaders
...
-   [Flickr Commons](https://www.flickr.com/commons) - Public Photo Archives / Downloader
...
-   [freepikuz\_pro](https://t.me/freepikuz_pro) - FreePik Downloader
...
-   [mockups-design](https://mockups-design.com/) - Product Mockups
-   [Nohat](https://nohat.cc/) - Stock Photos / Vectors
...
-   [PNGIMG](https://pngimg.com/) - PNG Photos / Noncommercial License
-   [publicdomainvectors](https://publicdomainvectors.org/) - Vector Images
-   [PxHere](https://pxhere.com/) - Stock Photos / CC0
-   [Shutterstock Premium](https://t.me/shutterstockpremium) - Shutterstock Telegram Downloaders
...
-   [VectorPortal](https://www.vectorportal.com/) - Vectores Images / Creative Common Attribution
...
-   [Danbooru](https://safebooru.donmai.us/) - Anime-Style Image Booru / Downloader
-   [Downloader](https://github.com/Nandaka/PixivUtil2) - Downloader, 2 / Rankings / Official Frontend / Frontend List / Preview, 2 / Android
-   [hydrus](https://hydrusnetwork.github.io/hydrus/) - Booru-Style Media Tagger
-   [Kemono](https://kemono.cr/posts?tag=) - Patreon Content / Some NSFW / Patreon Redirect, 2 / Use Adblock
...
-   [icons8](https://icons8.com/illustrations) - 3D Illustrations
...
-   [⁠PidgiWiki](https://www.pidgi.net/) - Video Game PNGs
-   [reshot](https://www.reshot.com/) - Misc Illustrations
-   [Safebooru](https://safebooru.org/) - Image Boorus
...
-   [⁠Zerochan](https://www.zerochan.net/?p=1) - Japanese Fanart / Some NSFW

#### Media Covers / Posters

-   [Ben Dodson](https://bendodson.com/projects/itunes-artwork-finder/) - Movies / TV / Music / Comic / Book / Anime / Manga
-   [BigBoxCollection](https://bigboxcollection.com/) - 3D Game Boxes
-   [Cover Century](https://www.covercentury.com/) - Movies / Games
-   [FanArt](https://fanart.tv/) - Poster Fanart
-   [GameTDB](https://www.gametdb.com/) - Games
-   [Movie Posters Gallery](https://www.moviepostersgallery.com/) - Movies
-   [r/MoviePosterPorn](https://www.reddit.com/r/MoviePosterPorn/) - Movie Poster Subreddit
-   [The Poster DB](https://theposterdb.com/) - Movies / TV
...
-   [Cults](https://cults3d.com/) - Printable 3D Models / Requires Sign-Up
...
-   [PolyHaven](https://polyhaven.com/) - Misc 3D Models
-   [PoseManiacs](https://www.posemaniacs.com/) - Pose References
-   [RIGModels](https://rigmodels.com/) - Rig / Animate 3D Models
-   [Sketchfab](https://sketchfab.com/) - Misc 3D Models / Requires Sign-Up
...
-   [MCprep](https://theduckcow.com/dev/blender/mcprep/) - All-in-one Minecraft Blender Addon
-   [Resources](https://awesome-blender.netlify.app/) - Resources, / Addons / Plugins / Textures / Renderer / 3D Nodes / AI Render
...
-   [Bforartists](https://www.bforartists.de/) - Cross-Platform 3D Modeling App
...
-   [Vectary](https://www.vectary.com/) - Online 3D Modeling Tools
...
-   [Embossify](https://www.embossify.com/) - Image to 3D Model Converters
...
-   [Ninja Ripper](https://gamebanana.com/tools/5638) - Extract 3D Models from Games
...
-   [OrcaSlicer](https://www.orcaslicer.com/) - 3D Printing Software
-   [Polymaker](https://wiki.polymaker.com/) - 3D Printer Guides / Learning
-   [⁠SpoolScout](https://www.spoolscout.com/) - Search / Compare 3D Printing Filament Prices
-   [⁠step.parts](https://www.step.parts/)
...
-   [BRL-CAD](https://brlcad.org/) - Cross-Platform CSG CAD Modeling
-   [CadHub](https://cadhub.xyz/) - Free CAD Files
-   [⁠Chili3d](https://chili3d.com/) - Web-Based CAD App
-   [FreeCAD](https://www.freecad.org/) - Parametric CAD Modeling
-   [LibreCAD](https://librecad.org/) - 2D CAD Modeling
-   [Mayo](https://github.com/fougue/mayo) - 3D CAD Viewer and Converter
-   [Tinkercad](https://www.tinkercad.com/) - Educational CAD Modeling

### Image Tools

-   [AntiDupl](https://github.com/ermig1979/AntiDupl) - Duplicate Image Removers
-   [ImgOps](https://imgops.com/) - Image Operations Meta-Tool
-   [Slowpoke Pics](https://slow.pics/) - Image Comparisons
...
-   [CamScanner](https://apps.apple.com/us/app/camscanner-pdf-scanner-app/id388627783) - Scan & Digitize Documents
-   [Cluttr](https://gitlab.com/bearjaws/cluttr) - Image File Organizers / Managers
-   [Glaze](https://glaze.cs.uchicago.edu/index.html) - Protect Digital Art from AI Copies
-   [Image Color Summarizer](https://mk.bcgsc.ca/color-summarizer/)
...
-   [Swapface](https://swapface.org/) - Face Swapping
...
-   [Caesium](https://saerasoft.com/caesium/) - Compression Software / Web App / CLI
...
-   [TinyPNG](https://tinypng.com/) - Batch Compressor / 20MB Upload
...
-   [Pingo](https://css-ig.net/pingo) - Image Optimization / GUI
...
-   [Capture2Text](https://capture2text.sourceforge.net/) - OCR Desktop Apps
...
-   [BeeRef](https://beeref.org/) - Reference Image Viewers
-   [Diffractor](https://www.diffractor.com/)
-   [FlipFlip](https://github.com/ififfy/flipflip/) - Image Slideshow
-   [G'MIC](https://gmic.eu/)
-   [HDRView](https://github.com/wkjarosz/hdrview) - HDR / Technical Image Viewers
...
-   [⁠NeeView](https://neelabo.github.io/NeeView/en-us/)
...
-   [⁠Urocissa](https://hsa00000.github.io/urocissa/) - Handles Millions of Images
...
-   [Google Takeout](https://takeout.google.com/) - Export from Google Photos / Script
...
-   [Imgur](https://imgur.com/) - 20MB Image / 200MB Animated / Forever / Upload Limits / Direct Link Grabber
-   [lookimg](https://lookimg.com/) - 20MB / Forever / Requires Sign-Up
-   [Piczel](https://piczel.tv/) - 10MB / Forever / Requires Sign-Up
-   [Rimgo](https://rimgo.codeberg.page/) - Imgur Frontend
...
-   [Catbox](https://catbox.moe/) - 200MB / Forever / Proxy
...
-   [pixelfed](https://pixelfed.org/) - Decentralized Image Sharing Social Network / Requires Sign-Up / Tools / Android
...
-   [ShareX](https://getsharex.com/) - Screenshot & Screen Recorder Tool / / Image Hosts / File Manager
-   [Zipline](https://zipline.diced.sh/) - Self-Hosted ShareX Server
...
-   [Moocup](https://moocup.jaydip.me/) - Screenshot Editors / Mockups
...
-   [Screenshot Guru](https://screenshot.guru/) - Take Screenshots of Websites
-   [Screenshot Rocks](https://screenshot.rocks/) - Create Screenshot Mockups of Websites
-   [ScreenshotX](https://screenshotx.com/)
-   [VideoToJPG](https://videotojpg.com/) - Video Frame Extraction

#### Palette Generators

-   [Color Designer](https://colordesigner.io/tools) - Color Palette Generators
-   [Clariss](https://www.clariss.xyz/) - Generate Color Palettes from Images
...
-   [ColorBox](https://colorbox.io/) - Advanced Color Palette Generators
-   [Colors Wall](https://colorswall.com/) - Generate Random Color Palettes
-   [Couleur.io](https://couleur.io/) - CSS Color Palettes Generator
-   [Good Palette](https://goodpalette.io/) - Generate UI Color Palettes
-   [Pigment](https://pigment.shapefactory.co/) - Simple Color Palette Generators
-   [Poolors](https://poolors.com/) - Generate Most / Least Used Color Palettes
-   [UI Colors](https://uicolors.app/create) - Tailwind CSS Color Generators
...
-   [Colorpicker](https://colorpicker.fr/) - Color Picker Desktop Apps
...
-   [Geenes](https://geenes.app/welcome) - Find UI Color Palettes
-   [Material UI](https://materialui.co/colors/) - Color Pickers
...
-   [darktable](https://www.darktable.org/) - RAW Photo Editors
...
-   [HDRMerge](https://jcelaya.github.io/hdrmerge/) - RAW Photography HDR Merge Tool
-   [MagicLantern](https://www.magiclantern.fm/) - Custom Canon EOS Firmware / Unsupported
...
-   [r/Photography Guide](https://www.reddit.com/r/photography/wiki/introduction) - Photography / Camera Guides

#### Photo Forensics / Metadata

-   [Fawkes](http://sandlab.cs.uchicago.edu/fawkes/) - Facial Cloaking
-   [FotoForensics](https://www.fotoforensics.com/) - Photo Forensics Tools
-   [Aperisolve](https://aperisolve.fr/) - Steganography Analysis Tool
-   [Base64 Image](https://www.base64-image.de/) - Encode / Decode Images
-   [exiftool](https://exiftool.org/) - Remove Meta / EXIF Data
...
-   [Picarta](https://picarta.ai/) - Image Geolocation / Location Estimation
...
-   [StegOnline](https://georgeom.net/StegOnline/upload) - Images Steganography Tools
-   [TheExifer](https://www.thexifer.net/) - Image EXIF Data Editors
-   [ViewEXIF](https://www.imgonline.com.ua/eng/exif-info.php) - EXIF / Metadata Viewers
