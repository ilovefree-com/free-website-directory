...
> Free adblockers, antivirus tools, VPN services, encrypted messengers, password managers, and privacy tools curated by the FMHY community.

### Adblocking

-   [Bookmarklet](https://github.com/mchangrh/sb.js) - Bookmarklet / Script / Ports / Database / Chromecast
-   [SponsorBlock](https://sponsor.ajay.app/) - Skip Sponsored YouTube Ads
-   [uAssets](https://github.com/uBlockOrigin/uAssets/issues) - uAssets / Hosts / AdGuard / EasyList
...
-   [Popup Blocker (strict)](https://github.com/schomery/popup-blocker) - Popup Blockers / Userscript
...
-   [AdGuard Home](https://adguard.com/en/adguard-home/overview.html) - Self-Hosted DNS Adblocking / Balena-AdGuard
-   [Filters](https://firebog.net/) - Filters / Tray App / Android Server (root)
-   [Mullvad DNS](https://mullvad.net/en/help/dns-over-https-and-dns-over-tls/) - DNS Adblocking / Filtering / Extension
...
-   [DNS Speed Test](https://dnsspeedtest.online/) - DNS Speed Tests
-   [DNSWarden](https://dnswarden.com/) - DNS Adblocking
-   [LibreDNS](https://libredns.gr/) - DNS Adblocking
-   [NextDNS](https://nextdns.io/) - Customizable DNS Adblocking Service / Video
...
-   [Malwarebytes](https://www.malwarebytes.com/) - Antivirus
-   [Security / Antivirus Multireddit](https://www.reddit.com/user/goretsky/m/security/) - Reddit Communities
-   [BleepingComputer](https://www.bleepingcomputer.com/forums/f/22/virus-trojan-spyware-and-malware-removal-help/) - Malware Removal Forums
...
-   [Sandboxie Plus](https://sandboxie-plus.com/) - Sandbox Environment / Guide, 2
...
-   [CLI](https://github.com/VirusTotal/vt-cli) - CLI / Uploader / Lite Version
-   [VirusTotal](https://www.virustotal.com/) - Online File Scanner
-   [Farbar](https://www.bleepingcomputer.com/download/farbar-recovery-scan-tool/) - Local File Scanner / Guide
-   [Filescan.io](https://www.filescan.io/) - Online File Scanner
...
-   [⁠Threat Insights Portal](https://www.threat.rip/) - Online File Scanner / Sign-Up Required
...
-   [Whonix](https://www.whonix.org/) - Privacy-Focused Operating Systems
-   [Agent DVR](https://www.ispyconnect.com/) - Security Camera Systems
...
-   [GnuPG](https://gnupg.org/) - Data / Communication Encryption Tool / Installer
...
-   [⁠Portable Secret](https://alcazarsec.github.io/portable-secret/) - Self-Contained HTML Files that Decrypt Locally in Browser
-   [PrivNote](https://privnote.com/) - Self-Destructing Messages / Private Notes
-   [Surfer Protocol](https://github.com/Surfer-Org/Protocol) - Multi-Platform User Data Exporter
...
-   [Awesome Privacy](https://awesome-privacy.xyz/) - Privacy Apps / Services
-   [Consumer Rights Wiki](https://consumerrights.wiki/) - Documents Practices That Impact Consumer Rights / Extension
-   [No Trace](https://www.notrace.how/) - Educational Guide
-   [Privacy Guides](https://www.privacyguides.org/) - Educational Guide / Discuss / / Matrix
-   [Surveillance Self-Defense](https://ssd.eff.org/) - Educational Guide
-   [The Hitchhiker’s Guide](https://anonymousplanet.org/) - Online Anonymity Guide
-   [The New Oil](https://thenewoil.org/) - Educational Guide
-   [The OPSEC Bible](http://opbible7nans45sg33cbyeiwqmlp5fu7lklu6jd6f3mivrjeqadco5yd.onion/) - Online Anonymity Guide / SimpleX Chat
...
-   [Beginner Privacy](https://beginnerprivacy.com/) - Beginners Privacy Guide / Checklist / Mastodon
...
-   [⁠Kicksecure Wiki](https://www.kicksecure.com/wiki) - Educational Guide / Forum
...
-   [⁠Whonix Wiki](https://www.whonix.org/wiki) - Educational Guide / Forum
...
-   [Hyphanet](https://www.hyphanet.org/) - Decentralized P2P Web
...
-   [PrivacySpy](https://privacyspy.org/) - Sites Privacy Policies
...
-   [Google Alt List](https://www.techspot.com/article/2752-all-google-alternatives/) - Google App Alternatives
-   [⁠OnionHop](https://www.onionhop.de/) - Tor Network Client / Onion Routing
...
-   [LibreWolf](https://librewolf.net/) - Custom Privacy-Focused Firefox / Auto-Updater, 2
-   [Mullvad Browser](https://mullvad.net/en/browser) - Tor Browser Fork (without Tor network)
-   [Tor Browser](https://www.torproject.org/) - Onion-Routed Browser / TG Downloads / Bridges
...
-   [⁠Disable JavaScript](https://disable-javascript.org/)
-   [Encrypted SNI](https://www.cloudflare.com/ssl/encrypted-sni/) - Cloudflare Browser Check
-   [⁠Phoenix](https://codeberg.org/celenity/Phoenix) - Firefox Privacy Tweak

#### Password Privacy / 2FA

-   [Aegis](https://getaegis.app/) - 2FA
-   [Ente Auth](https://ente.com/auth/)
-   [Ente Auth](https://ente.io/auth/) - 2FA / All Platforms
-   [Password Strength Chart](https://i.ibb.co/B2Vz3hSj/89x5g3t4xrxe1.png)
-   [Stratum](https://stratumauth.com/) - 2FA
-   [2FA Directory](https://2fa.directory/) - List of Sites with 2FA Support
-   [2FAS](https://2fas.com/) - 2FA
-   [2FAuth](https://docs.2fauth.app/) - Self-Hosted
-   [Authenticator](https://authenticator.cc/) - 2FA Browser Extension
-   [AuthMe](https://authme.levminer.com/) - 2FA
-   [FreeOTPPlus](https://github.com/helloworld1/FreeOTPPlus) - 2FA
-   [KeePassXC](https://keepassxc.org/) - 2FA / / Guide
-   [Mauth](https://github.com/X1nto/Mauth) - 2FA
-   [OTP Auth](https://apps.apple.com/app/otp-auth/id659877384) - 2FA
-   [OTP Helper](https://github.com/jd1378/otphelper) - Extract OTP Tokens
-   [OTPClient](https://github.com/paolostivanin/OTPClient) - 2FA
-   [⁠Proton Authenticator](https://proton.me/authenticator) - 2FA / All Platforms
-   [Sentinel](https://getsentinel.io/) - 2FA
-   [steamguard-cli](https://github.com/dyc3/steamguard-cli) - Generate Steam 2FA Codes
-   [Tofu](https://www.tofuauth.com/) - 2FA
-   [VaultWarden](https://github.com/dani-garcia/vaultwarden) - Unofficial Bitwarden Server Backend / Self-Hosted
-   [Yubioath](https://developers.yubico.com/yubioath-flutter/) - 2FA / YubiKey Support

#### Encrypted Messengers

-   [Briar](https://briarproject.org/)
-   [Signal](https://signal.org/) - All Platforms / Requires Phone / or Molly / Some NSFW / Stickers
-   [SimpleX](https://simplex.chat/) - All Platforms
-   [Berty](https://berty.tech/)
-   [Cabal](https://cabal.chat/) - P2P / Serverless All Platforms
-   [Cwtch](https://docs.cwtch.im/)
-   [Damus](https://damus.io/)
-   [Databag](https://github.com/balzack/databag) - Self-Hosted
-   [Delta Chat](https://delta.chat/) - Decentralized Email-Based Messenger
-   [Eylenburg Comparisons](https://eylenburg.github.io/im_comparison.htm) - Chat App Indexes / Comparisons
-   [Jami](https://jami.net/) - All Platforms
-   [Keybase](https://keybase.io/) - All Platforms
...
-   [Session](https://getsession.org/) - All Platforms
-   [ssh-chat](https://github.com/shazow/ssh-chat) - SSH Chat
-   [Status](https://status.app/)
-   [Tox](https://tox.chat/) - All Platforms
-   [Wire](https://wire.com/en/download/) - All Platforms / Requires Phone

#### Email Privacy

-   [Proton Mail](https://proton.me/mail) - 1GB Free / Encrypted Email / Deleted After 1 Year Inactive / / / More Storage
-   [Tuta](https://tuta.com/) - 1GB Free / Encrypted Email / Deleted After 6 Months Inactive
-   [Disroot](https://disroot.org/en/services/email) - 1GB Free / Encrypted Email
-   [DNMX](https://dnmx.cc/) - Onion-Based Email
-   [Email Privacy Tester](https://www.emailprivacytester.com/) - Email Privacy Test
...
-   [BreachDirectory](https://breachdirectory.org/) - Data Breach Search Engines
-   [Intelligence X](https://intelx.io/) - Password Breach Check
-   [Mozilla Monitor](https://monitor.mozilla.org/) - Data Breach Check / Requires Sign-Up
-   [ScatteredSecrets](https://scatteredsecrets.com/) - Password Breach Check / Requires Sign-Up

#### Fingerprinting / Tracking

-   [CreepJS](https://abrahamjuliot.github.io/creepjs) - Tracking / Fingerprinting Tests
-   [AnonymousRedirect](https://adguardteam.github.io/AnonymousRedirect/) - Anonymize Links
-   [BrowserLeaks](https://browserleaks.com/) - IP Leak Tests
-   [ClearURLs](https://docs.clearurls.xyz/) - Clean URLs / Remove Tracking Elements from URLs / Can Break Sites
...
-   [JShelter](https://jshelter.org/) - Prevent Fingerprinting / Warning
-   [Locale Switcher](https://chromewebstore.google.com/detail/locale-switcher/kngfjpghaokedippaapkfihdlmmlafcc) - Change Language Identifier
-   [Webbkoll](https://webbkoll.5july.net/) - Site Tracking Info
-   [X.com Direct](https://greasyfork.org/en/scripts/404632) - Removes t.co Tracking from X.com

#### Search Engines

-   [4get](https://4get.canine.tools/) - Metasearch / Instances
-   [Brave Search](https://search.brave.com/) - Independent / Supports DDG Bangs
-   [DuckDuckGo](https://start.duckduckgo.com/) - Metasearch / Bing Based / AI Free / Lite / HTML / Shortcuts, 2
-   [Degoog](https://github.com/fccview/degoog/blob/main/docs/repo/PUBLIC_INSTANCES.md) - Metasearch / Docs
-   [LibreY](https://ly.owo.si/) - Metasearch / Instances, 2
-   [Mojeek](https://www.mojeek.com/) - Independent
-   [⁠Nilch](https://nilch.org/) - AI Free / Metasearch
-   [Search Engine Party](https://searchengine.party/) - Privacy Search Engine Comparisons
-   [Startpage](https://www.startpage.com/) - Google Based
-   [YaCy](https://yacy.net/) - Decentralized / P2P Independent

### VPN

-   [AirVPN](https://airvpn.org/) - Paid
-   [Cloudflare One](https://one.one.one.one/) - Free / Unlimited / Wireguard (kill switch) / Config Generator
-   [IVPN](https://www.ivpn.net/) - Paid / No-Log / No Port Forwarding
-   [Mullvad VPN](https://mullvad.net/) - Paid / No-Log / No Port Forwarding
-   [Proton VPN](https://protonvpn.com/) - Free & Paid / Unlimited / Wireguard
-   [Windscribe](https://windscribe.com/) - Free & Paid / 10GB Monthly / No Torrenting w/ Free Plan
-   [Calyx VPN](https://calyxos.org/docs/guide/apps/calyx-vpn/) - Free / Unlimited
-   [Nym](https://nym.com/) - Paid / 5-Hop Mixnet
-   [PrivadoVPN](https://privadovpn.com/freevpn) - Free / 10GB Monthly / Unlimited Accounts via Temp Mail
-   [RiseupVPN](https://riseup.net/en/vpn) - Free / Unlimited / No Port Forwarding
-   [Techlore Chart](https://vpn.techlore.tech/) - VPN Comparison Charts
-   [VPN Relationships](https://kumu.io/Windscribe/vpn-relationships) - VPN Relationship Map

#### VPN Server

-   [Tailscale](https://tailscale.com/) - WireGuard Mesh
-   [WireGuard](https://www.wireguard.com/) - VPN Tunnel / Guide / Web UI
-   [Algo VPN](https://blog.trailofbits.com/2016/12/12/meet-algo-the-vpn-that-works/) - Cloud VPN
-   [Amnezia](https://amnezia.org/) - VPN Server
...
-   [Cloudflare Tunnels](https://developers.cloudflare.com/cloudflare-one/connections/connect-networks/) - Application Tunnel / VPN Alternative / WireGuard
...
-   [⁠Nebula](https://github.com/slackhq/nebula) - Mesh VPN Server
-   [Openconnect](https://ocserv.gitlab.io/www/index.html) - SSL VPN Server
-   [OpenConnect](https://gitlab.com/openconnect/openconnect) - SSL VPN / GUI
-   [OpenVPN](https://openvpn.net/) - VPN Server
-   [Pritunl](https://pritunl.com/) - VPN Server
-   [SShuttle](https://sshuttle.readthedocs.io/en) - SSH VPN Server
-   [tinc VPN](https://www.tinc-vpn.org/) - VPN Tunnel
-   [⁠Twingate](https://www.twingate.com/) - Zero Trust Access Tunnel
-   [WGDashboard](https://wgdashboard.dev/) - WireGuard Panel / AmneziaWG
-   [WireHole](https://github.com/IAmStoxe/wirehole) - WireGuard + Pi-hole VPN / Web UI
...
-   [WG Tunnel](https://wgtunnel.com/) - WireGuard Client / AmneziaWG / / Windows
-   [⁠WireSock](https://wiresock.net/) - WireGuard Split Tunneling Clients

### Proxy

-   [Acrylic](https://mayakron.altervista.org/) - Local DNS Proxy
-   [Censor Tracker](https://censortracker.org/) - Proxy Extensions
-   [FreeSocks](https://freesocks.org/) - Shadowsocks App
-   [Lantern](https://lantern.io/) - Proxy App / Slowed Past 250MB
-   [Psiphon](https://psiphon.ca/) - Hybrid Proxy VPN App
-   [SimpleDnsCrypt](https://github.com/instantsc/SimpleDnsCrypt) - Local DNS Encryption Proxy
-   [Snowflake](https://snowflake.torproject.org/) - Tor Proxy Browser Extension

#### Proxy Servers

-   [3X-UI](https://github.com/MHSanaei/3x-ui) - Proxy Panel / / Guide
-   [Project X](https://github.com/XTLS/Xray-core) - Xray Proxy Core / , 2
-   [Amnezia](https://amnezia.org/self-hosted) - Multi Protocol Server
-   [Hiddify Manager](https://hiddify.com/) - Proxy Panel
-   [Hysteria](https://v2.hysteria.network/) - Speed Focused Proxy Protocol
-   [NaïveProxy](https://github.com/klzgrad/naiveproxy) - Chromium-based Proxy
-   [Nginx Proxy Manager](https://nginxproxymanager.com/) - Reverse Proxy UI
-   [Outline](https://getoutline.org/)
-   [Scramjet](https://docs.titaniumnetwork.org/proxies/scramjet/) - Web Proxy Server
-   [Shadowsocks](https://shadowsocks.org/) - Simple Proxy Protocol
-   [sing-box](https://sing-box.sagernet.org/) - Proxy Core
-   [VpnHood](https://github.com/vpnhood/VpnHood) - Proxy Server

#### Proxy Clients

-   [NekoBox](https://matsuridayo.github.io/) - Proxy Client
-   [v2rayN](https://github.com/2dust/v2rayN) - Proxy Client
-   [Amnezia](https://amnezia.org/) - VPN Server
-   [ClashVerge](https://www.clashverge.dev/) - Proxy Client
-   [⁠Exclave](https://github.com/dyhkwong/Exclave)
-   [⁠FlClash](https://github.com/chen08209/FlClash/blob/main/README.md)
-   [Hiddify Manager](https://hiddify.com/) - Proxy Panel
-   [husi](https://github.com/xchacha20-poly1305/husi) - Proxy Client
-   [Proxifier](https://www.proxifier.com/) - Add Proxy Functionality to Apps
-   [Shadowsocks](https://shadowsocks.org/doc/getting-started.html#gui-clients) - Shadowsocks Client / All Platforms
-   [sing-box](https://sing-box.sagernet.org/clients/) - Proxy Client
-   [Streisand](https://streisand.pages.dev/) - Proxy Client
-   [Throne](https://throneproj.github.io/) - Proxy Client / Sing-Box GUI
-   [v2rayNG](https://github.com/2dust/v2rayNG) - Proxy Client
-   [wireproxy](https://github.com/whyvl/wireproxy) - WireGuard as Proxy

#### Anti Censorship

-   [ByeDPIAndroid](https://github.com/dovecoteescapee/ByeDPIAndroid) - Network Packet Alter Tool
-   [Censorship Bypass Guide](https://cbg.fmhy.bid/)
-   [DNSveil](https://msasanmh.github.io/DNSveil/) - DNS Client
-   [⁠Net4people](https://github.com/net4people/bbs/issues) - Worldwide Censorship Circumvention Discussion
-   [zapret](https://github.com/bol-van/zapret) - Network Packet Alter Tools
-   [ByeByeDPI](https://github.com/romanvht/ByeByeDPI/blob/master/README-en.md) - Network Packet Alter / Packet Level Proxies
-   [DNSTT.XYZ](https://dnstt.xyz/) - Mobile DNS Tunnels / Censorship Bypass
-   [⁠FilterWatch](https://filter.watch/english/) - Censorship News / Articles
-   [⁠Geph](https://geph.io/) - Anti-Censorship Proxy
...
-   [Proxy Checker](https://proxy-checker.net/) - Proxy Scrapers / Checkers
-   [Proxyium](https://proxyium.com/)
-   [ProxyOf2](https://proxyof2.com/)
-   [ProxyPal](https://proxypal.net/)
-   [Reflect4](https://reflect4.me/)
-   [SSLSecureProxy](https://www.sslsecureproxy.com/)
-   [Startpage](https://www.startpage.com/) - Google Based
-   [Titanium Network](https://titaniumnetwork.org/services/) - Multi-Proxy / Instances
