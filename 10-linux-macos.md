...
> Free Linux guides, distros, apps, tools, Mac software, and customization resources curated by the FMHY community.

### Linux Guides

-   [ArchWiki](https://wiki.archlinux.org/) - Linux Guides / Manuals / TUI
...
-   [Linux Command Library](https://linuxcommandlibrary.com/) - Searchable Linux Command Index
...
-   [cheat.sh](https://github.com/chubin/cheat.sh) - Terminal Commands
...
-   [DistroChooser](https://distrochooser.de/) - Quiz-Based Distro Selector
-   [ArchiveOS](https://archiveos.org/) - Inactive / Open-Source OS Projects
-   [distro.moe](https://distro.moe/) - Random Distro Finder
-   [DistroWatch](https://distrowatch.com/dwres.php?resource=popularity) - Distro Index w/ News + Rankings / Advanced Search
...
-   [FreeRDP](https://www.freerdp.com/) - Remote Desktop Clients
-   [Q4Wine](https://sourceforge.net/projects/q4wine/) - Wine GUI
-   [rofi](https://davatorium.github.io/rofi/) - App Launchers / Keystroke Launchers
-   [shell\_gpt](https://github.com/TheR1D/shell_gpt) - AI Terminal Chatbot / GPT
...
-   [Autokey](https://autokey.github.io/index.html) - Linux Automation Utility
...
-   [Eloquent](https://github.com/sonnyp/Eloquent) - Grammar Check Apps
-   [Featherpad](https://github.com/tsujan/FeatherPad) - Text Editors
-   [GammaStep](https://gitlab.com/chinstrap/gammastep) - Adjust Screen Temperature
-   [Ghostwriter](https://ghostwriter.kde.org/) - Markdown Editor
...
-   [Komikku](https://flathub.org/en/apps/info.febvre.Komikku) - Manga Readers
-   [KTouch](https://apps.kde.org/ktouch/) - Typing Practice
...
-   [Mako](https://github.com/emersion/mako) - Customizable Notification Daemon
...
-   [taskbook](https://github.com/klaudiosinani/taskbook) - Note Apps
...
-   [Kapital Sin](https://www.kapitalsin.com/forum/index.php?board=5.0) - Linux Software / Use Translator
-   [RuTracker ROMs](https://rutracker.org/forum/viewforum.php?f=548) - ROMs / Torrents / Use VPN / Tools
-   [The Book of Secret Knowledge](https://github.com/trimstray/the-book-of-secret-knowledge)
-   [AppImageHub](https://www.appimagehub.com/) - Download AppImages
...
-   [Flatpak](https://flatpak.org/) - Sandboxed Package Manager / App Repository / Manage Permissions
...
-   [KDE Applications](https://apps.kde.org/) - KDE Apps & Themes
-   [Nala](https://gitlab.com/volian/nala) - TUI Frontends for APT Package Manager
-   [Nix](https://nixos.org/) - Package Managers
...
-   [Rim's Linux Wiki](https://rlw.pages.dev/) - Linux Software / Tool Index
-   [SnapCraft](https://snapcraft.io/store) - Snap Repository
-   [⁠TuxMate](https://tuxmate.com/) - Bulk App Installer
-   [Zap](https://zap.srev.in/) - App Image Managers

#### Linux System

-   [Btop](https://github.com/aristocratos/btop) - System Resource Monitors
-   [fastfetch](https://github.com/fastfetch-cli/fastfetch) - System Info Displays
-   [MangoHud](https://github.com/flightlessmango/MangoHud) - System Resource Monitor Overlay / GUI
-   [TimeShift](https://github.com/linuxmint/timeshift) - System Restore / Backup
-   [anuraOS](https://github.com/MercuryWorkshop/anuraOS) - Linux Browser Emulator
...
-   [CloverBootloader](https://github.com/CloverHackyColor/CloverBootloader/) - Windows, Mac & Linux Bootloader / Config
-   [coreboot](https://coreboot.org/) - Replace Proprietary BIOS/UEFI Firmware
-   [CoreELEC](https://coreelec.org/) - Kodi-Based Operating System
...
-   [Hardware for Linux](https://linux-hardware.org/) - Linux Hardware Compatibility Database
-   [htop](https://htop.dev/) - Interactive Process Viewers
...
-   [keyd](https://github.com/rvaiya/keyd) - Keyboard Remapping
...
-   [Nanobench](https://github.com/andreas-abel/nanoBench) - CPU Microbenchmark / Documentation
...
-   [OSX-KVM](https://github.com/kholia/OSX-KVM) - macOS Virtual Machines
...
-   [SystemRescue](https://www.system-rescue.org/) - Bootable System Rescue Toolkits
...
-   [WebVM](https://webvm.io/) - Browser Virtual Machine
...
-   [Haruna](https://apps.kde.org/haruna/) - MPV Frontends
-   [Kdenlive](https://apps.kde.org/kdenlive/) - Video Editors
-   [mpv](https://mpv.io/) - Video Players
-   [4KTUBE](https://github.com/rishabh3354/4KTUBE) - Video Downloaders
...
-   [Shortwave](https://flathub.org/en/apps/de.haeckerfelix.Shortwave) - Radio Players
-   [SongRec](https://github.com/marin-m/SongRec) - Song Identifiers
...
-   [Audacious](https://audacious-media-player.org/) - Lightweight Audio Player
-   [AudioTube](https://invent.kde.org/multimedia/audiotube) - YouTube Music Clients
-   [Awesome Linux Audio](https://gitlab.com/nodiscc/awesome-linuxaudio) - Live Audio Resources
-   [BeatBoss](https://beatboss.thevolecitor.qzz.io/) - Streaming / Plugin-Based
...
-   [cliamp](https://www.cliamp.stream/) - TUI Audio Players
-   [cmus](https://cmus.github.io/) - Audio Player
-   [Deezer Linux](https://github.com/aunetx/deezer-linux) - Deezer Clients
-   [Dopamine](https://github.com/digimezzo/dopamine) - Simple Audio Player
-   [Ensembles](https://github.com/ensemblesaw/ensembles-app) - Musical Performance Arranger
-   [Fooyin](https://www.fooyin.org/) - Audio Player
...
-   [⁠LibrePods](https://github.com/kavishdevar/librepods) - Add AirPod Features to Android / Root Requirments
...
-   [Pipewire](https://pipewire.org/) - Improved Video / Audio Handling / Multimedia API / Effects / TUI Audio Mixer
-   [puddletag](https://docs.puddletag.net/) - Metadata Organizer
-   [Qtractor](https://qtractor.org/) - Audio Editor
-   [⁠Sonosano](https://sonosano.krshh.com/) - Self-Hosted P2P Lossless Music Player
...
-   [Werman](https://github.com/werman/noise-suppression-for-voice) - Noise Suppression Software
...
-   [Client Evolution](https://help.gnome.org/users/evolution/stable/) - Calendars
-   [dijo](https://github.com/oppiliappan/dijo) - Activity Tracker
-   [Timestrap](https://timestrap.bythewood.me/) - Productivity Managers
-   [todo](https://github.com/sioodmy/todo/) - To-Do Apps

#### Linux Gaming

-   [Bottles](https://usebottles.com/) - Manage Wine containers
-   [CS.RIN.RU](https://cs.rin.ru/forum) - Download / Signup / PW: cs.rin.ru / csrin.org
-   [GE-Proton](https://github.com/GloriousEggroll/proton-ge-custom) - Custom Proton Version
-   [Heroic Games Launcher](https://heroicgameslauncher.com/) - Game Launchers
-   [Kapital Sin](https://www.kapitalsin.com/forum/index.php?board=5.0) - Linux Software / Use Translator
-   [Linux Gaming Wiki](https://linux-gaming.kwindu.eu/index.php?title=Main_Page) - Linux Gaming Guides
-   [protondb](https://www.protondb.com/) - Game Compatibility Databases
-   [ProtonPlus](https://github.com/Vysp3r/ProtonPlus) - Linux Compatibility Tool Managers
-   [RuTracker ROMs](https://rutracker.org/forum/viewforum.php?f=548) - ROMs / Torrents / Use VPN / Tools
...
-   [CreamLinux](https://github.com/anticitizn/creamlinux) - Steam DLC Unlocker / Installer
...
-   [⁠LeShade](https://github.com/Ishidawg/LeShade)
...
-   [Liquorix](https://liquorix.net/) - Linux Gaming Kernels
-   [⁠lsfg-vk](https://github.com/PancakeTAS/lsfg-vk) - Lossless Scaling for Linux
-   [Luxtorpeda](https://github.com/luxtorpeda-dev/luxtorpeda) - Run Steam Games on Linux
...
-   [PortMaster](https://portmaster.games/) - Port Games to Linux Handheld Devices
...
-   [Sober](https://sober.vinegarhq.org/) - Roblox Linux Port / Vinegar (Studio Only)
-   [ssprea-nvidia-control](https://github.com/ssprea/ssprea-nvidia-control) - GPU Overclocking Tools
...
-   [Arch Security Wiki](https://wiki.archlinux.org/title/Security) - Linux Security Guides
-   [CryptSetup](https://gitlab.com/cryptsetup/cryptsetup) - File Encryption
-   [Collision](https://flathub.org/apps/dev.geopjr.Collision) - Check File Hashes
-   [Firejail](https://firejail.wordpress.com/) - Sandboxing Tools
...
-   [Lockigest](https://elma.dev/works/lockigest/) - Screen Locker
...
-   [OpenSnitch](https://github.com/evilsocket/opensnitch) - Linux Firewalls
-   [Securely Wipe Disk](https://wiki.archlinux.org/title/Securely_wipe_disk) - Linux Disk Wipe Guides
...
-   [WhoAmI Project](https://owerdogan.github.io/whoami-project) - Privacy / Anonymity Tool
...
-   [Nicotine+](https://nicotine-plus.org/) - P2P Audio Sharing Networks / Stats / Server App / Batch
-   [Adium](https://adium.im/) - IRC Clients
-   [Akregator](https://apps.kde.org/akregator/) - RSS Readers
...
-   [⁠dae](https://github.com/daeuniverse/dae) - Linux Router Performance Proxy App / WebUI
...
-   [KGet](https://apps.kde.org/kget/) - Download Managers
...
-   [YouTube-Viewer](https://github.com/trizen/youtube-viewer) - YouTube Clients
-   [ZapZap](https://rtosta.com/zapzap/) - WhatsApp Client

#### Server / Selfhosting

-   [Homepage](https://gethomepage.dev/) - Home Server Startpages
...
-   [Awesome Selfhosted](https://awesome-selfhosted.net/) - Self-Hosted Software Index
-   [⁠ConvertX](https://github.com/C4illin/ConvertX) - Self-Hosted File Converters
...
-   [iRedMail](https://www.iredmail.org/) - Self-Hosted Email Servers
-   [⁠LXD UI](https://github.com/canonical/lxd-ui) - Linux Container + Virtual Machine Manager
-   [openmediavault](https://www.openmediavault.org/) - Self-Hosted Cloud Storage
-   [Proxmox](https://www.proxmox.com/) - Self-Hosted Server Tools / Virtual Environment
-   [r/SelfHosted Wiki](https://wiki.r-selfhosted.com/) - Self-Hosting Guides / Resources / Community
...
-   [Self Managed Life](https://wiki.futo.org/) - FOSS / Self-Hosting Guide / Video, 2
...
-   [serverbox](https://cdn.lpkt.cn/serverbox/) - Linux Server Managers / Status
...
-   [Tube Archivist](https://www.tubearchivist.com/) - Self-Hosted YouTube Media Server
-   [Whoogle Search](https://github.com/benbusby/whoogle-search) - Self-Hosted Search Engines
-   [yet another bench script](https://github.com/masonr/yet-another-bench-script) - Server Performance Script

#### File Tools

-   [Baobab](https://gitlab.gnome.org/GNOME/baobab) - Disk Usage Analyzers / GUI
-   [dut](https://codeberg.org/201984/dut) - Disk Usage Analyzers / CLI
-   [lf](https://github.com/gokcehan/lf) - Terminal File Managers
-   [Warpinator](https://github.com/linuxmint/warpinator) - File Sync / Transfer
-   [ANGRYsearch](https://github.com/DoTheEvo/ANGRYsearch) - File Explorers / Search
-   [Boxxy](https://github.com/queer/boxxy) - Contain Files / Directories
-   [Collector](https://mijorus.it/projects/collector/) - File Drag & Drop
-   [Dolphin](https://userbase.kde.org/Dolphin) - File Managers
...
-   [lnav](https://lnav.org/) - Log File Viewer / Analyzer
-   [PDF Mix](https://scarpetta.eu/pdfmixtool/) - PDF Editor
-   [PeaZip](https://peazip.github.io/) - File Archivers / Unzippers / Compression
-   [Pika Backup](https://gitlab.gnome.org/World/pika-backup/) - File Backup / Reocovery Tools
...
-   [Waydroid](https://waydro.id/) - Containerized Android on Linux / Scripts
...
-   [Alacritty](https://alacritty.org/) - Linux Terminal Emulators
-   [LinuxCommand](https://www.linuxcommand.org/tlcl.php) - Command-Line Lessons
-   [Plugins](https://github.com/unixorn/awesome-zsh-plugins) - Plugins / Customization / Theme / Auto Setup / Rich Framework
-   [zsh](https://www.zsh.org/) - Command Line Shells
-   [atuin](https://atuin.sh/) - Shell History Management
-   [Awesome Shell](https://github.com/alebcay/awesome-shell) - Linux Shell Resources
-   [⁠Awesome Terminal Recorder](https://github.com/orangekame3/awesome-terminal-recorder) - Terminal Recorder Index
-   [Awesome TUIs](https://github.com/rothgar/awesome-tuis) - TUI Indexes
-   [Bash Crawl](https://gitlab.com/slackermedia/bashcrawl) - Linux Command Learning Game
-   [bash\_loading\_animations](https://github.com/Silejonu/bash_loading_animations) - Bash Loading Animations
-   [bash-it](https://github.com/Bash-it/bash-it) - Bash Frameworks
-   [Basher](https://www.basher.it/) - Bash Package Manager
...
-   [pipes.sh](https://pipeseroni.github.io/) - Animated Pipes in Terminal
-   [ShellCheck](https://www.shellcheck.net/) - Shell Script Bug Check
-   [⁠ShellScript](https://www.shellscript.sh/) - Shell Scripting Tutorials
-   [Starship](https://starship.rs/) - Bash / Zsh Prompt
-   [Tmux](https://github.com/tmux/tmux) - Terminal Multiplexer / Cheatsheet
-   [utils](https://github.com/Loupeznik/utils) - Linux Shell Tool Scripts
-   [Zellij](https://zellij.dev/) - Terminal Workspace
-   [zx](https://google.github.io/zx/) - Write Complex Scripts
...
-   [PiVPN](https://pivpn.io/) - Raspberry Pi VPN
...
-   [Elkowar's Wacky Widgets](https://elkowar.github.io/eww) - Widgeting Systems
-   [unixporn](https://unixporn.github.io/) - Customization Community
-   [Awesome Ricing](https://github.com/fosslife/awesome-ricing) - Linux Customization Resources
...
-   [awesomewm](https://awesomewm.org/) - Dynamic Tiling Window Managers
-   [Hyprland](https://hypr.land/) - Dynamic Tiling Wayland Compositor / Resources / Arch Wiki / Simple Config, 2
-   [i3wm](https://i3wm.org/) - Manual Tiling Window Manager / Reference Card
-   [niri](https://github.com/YaLTeR/niri) - Scrollable-Tiling Wayland Compositor
-   [Sway](https://github.com/swaywm/sway) - i3-compatible Wayland Compositors
...
-   [mangowm](https://mangowm.github.io/) - Dynamic Tiling Wayland Compositor
-   [picom](https://github.com/yshui/picom) - Compositor for Standalone X11 Window Managers / Docs
-   [Polybar (X11)](https://github.com/polybar/polybar) - Customizable Status Bars
...
-   [We Are Wayland Now](https://wearewaylandnow.com/) - Wayland Ecosystem Components
-   [Window Manager Index](https://wiki.archlinux.org/title/Window_manager) - List of Window Managers

#### Linux Themes

-   [AeroThemePlasma](https://github.com/WackyIdeas/aerothemeplasma) - Windows 7 / Vista Themes for KDE Plasma
...
-   [⁠tint](https://github.com/ashish0kumar/tint) - Recolor Wallpapers for System Scheme / GUI
-   [varietywalls](https://github.com/varietywalls/variety) - Wallpaper Managers
-   [Video Wallpaper](https://github.com/ghostlexly/gpu-video-wallpaper) - Use Videos as Animated Wallpapers
...
-   [NearDrop](https://github.com/grishka/NearDrop) - File Sharing Apps
...
-   [Agenda](https://agenda.com/) - Date-Focused Note Organizer / Forum
...
-   [Clearly](https://clearly.md/) - Markdown Editor
-   [CodexBar](https://codexbar.app/) - Menu Bar AI Limit Tracker
...
-   [Hammerspoon](https://www.hammerspoon.org/) - Desktop Automation via Lua Scripts
...
-   [Linux for T2](https://t2linux.org/) - Install Linux on Apple T2 Devices
-   [MacBing](https://goodsnooze.gumroad.com/l/macbing) - AI Chatbots
-   [macOSicons](https://macosicons.com/) - macOS App Icons
-   [MacScripter](https://www.macscripter.net/) - Automation Forum
-   [MacVim](https://macvim.org/) - Code Editors
...
-   [PlayCover](https://playcover.io/) - Run iOS Apps on Apple Silicon Macs
-   [pongoOS](https://github.com/checkra1n/pongoOS) - Mac Pre-Boot Executor
-   [PortingKit](https://www.portingkit.com/) - Run Windows Games / Programs on Mac
-   [ProperTree](https://github.com/corpnewt/ProperTree) - GUI Plist Editor
-   [rEFind](https://www.rodsbooks.com/refind/) - Boot Manager
-   [SD Buddy](https://github.com/breadthe/sd-buddy) - Stable Diffusion Apps
...
-   [Tachidesk-Sorayomi](https://github.com/Suwayomi/Tachidesk-Sorayomi) - Manga Reader / Extensions, 2, 3
-   [Tart](https://tart.run/) - Virtual Machine Manager
-   [Taskpaper](https://www.taskpaper.com/) - Plain Text To-Do Lists
-   [TopNotch](https://topnotch.app/) - Hide the Notch on MacBooks
-   [⁠TypeWhisper](https://www.typewhisper.com/en/) - Text to Speech
...
-   [UTM](https://mac.getutm.app/) - Virtual Machines / Run Linux or Windows on macOS
...
-   [Homebrew](https://brew.sh/) - Package Managers / Homebrew GUI
-   [RuTracker ROMs](https://rutracker.org/forum/viewforum.php?f=548) - ROMs / Torrents / Use VPN / Tools
-   [Antibiotic's](https://t.me/AntibioticsChannel)
-   [AppsTorrent](https://appstorrent.ru/) - Downloads (not torrents)
-   [Awesome macOS](https://github.com/iCHAIT/awesome-macOS) - FOSS App Indexes
-   [emplace](https://codeberg.org/fosk/emplace)
...
-   [AnymeX](https://anymex.vercel.app/)
-   [Cap](https://cap.so/) - Screen Recorders / Cap GitHub
-   [Fusion](https://fusionapp.dev/)
-   [Hayase](https://hayase.watch/) - Torrent Streaming App / Extensions / Wiki
-   [IINA](https://iina.io/) - Video Player
-   [⁠LonelyScreen](https://www.lonelyscreen.com/) - AirPlay Receiver for PC / macOS
-   [REAL Video Enhancer](https://github.com/TNTwise/REAL-Video-Enhancer) - Video Upscaling
-   [⁠Unwatched](https://apps.apple.com/app/unwatched-para-youtube/id6477287463) - YouTube Players
...
-   [foobar2000](https://www.foobar2000.org/mac) - Audio Players
-   [Garageband](https://apps.apple.com/us/app/garageband/id682658836?mt=12) - Audio Editor
-   [Guitarix](https://guitarix.org/) - Virtual Guitar Amplifier / Plugins
...
-   [TheBoringNotch](https://theboring.name/) - Turn Notch into Audio Controller / Calendar
...
-   [Mythic](https://getmythic.app/) - Epic Games Launcher
...
-   [Malwarebytes](https://www.malwarebytes.com/mac-download) - Antivirus
...
-   [mac\_apt](https://github.com/ydkhatri/mac_apt) - Artifact Parsing Tool
...
-   [ElectronMail](https://github.com/vladimiry/ElectronMail) - Email Clients
-   [KeePassXC](https://keepassxc.org/download/#macos) - Password Managers
-   [Orion](https://kagi.com/orion/) - Adblock Browser w/ Extensions
-   [What Route](https://whatroute.net/) - Network Diagnostic Tool

#### System Tools

-   [Alfred](https://www.alfredapp.com/) - Keystroke Launchers / Spotlight Replacements / Alfred Workflows / Themes / Albert GitHub
...
-   [AirBattery](https://github.com/lihaoyun6/AirBattery) - Device Battery Trackers
...
-   [Clocker](https://abhishekbanthia.com/clocker/) - Menu Bar Meetings Calendars
-   [Conky](https://conky.cc/) - Hardware / System Monitors / Conky Colors
-   [DarkModeBuddy](https://github.com/insidegui/DarkModeBuddy) - System Dark Mode Apps
...
-   [LinearMouse](https://linearmouse.app/) - Mouse Remapping
-   [Mac Menu Bar](https://macmenubar.com/) - Menu Bar App Index
-   [Maccy](https://maccy.app/) - Clipboard Managers
...
-   [Pearcleaner](https://itsalin.com/appInfo/?id=pearcleaner) - System Cleanup / Uninstaller
...
-   [pock](https://pock.app/) - Touch Bar Widget Manager
...
-   [wallpapper](https://github.com/mczachurski/wallpapper) - Dynamic Wallpaper Creators
-   [WhatCable](https://whatcable.uk/)
-   [xbar](https://xbarapp.com/) - Manage Menu Bar Items
-   [Yabai](https://github.com/koekeishiya/yabai) - Window Managers

#### File Tools

-   [PeaZip](https://peazip.github.io/peazip-macos.html) - File Archivers
-   [Readdle](https://readdle.com/documents) - Multipurpose File Tool
-   [Bruji](https://www.bruji.com/) - Media Cataloging Software Suite
-   [FlyingCarpet](https://github.com/spieglt/FlyingCarpet) - Cross-Platform AirDrop / Guide
-   [fzf](https://github.com/junegunn/fzf) - Fuzzy Finders
-   [Go Speed](https://gopeed.com/) - File Download Manager / Extension / Plugins
-   [JDownloader](https://jdownloader.org/jdownloader2) - File Download Manager / Debloat / Dark Theme, 2 / Dracula Theme
-   [macFUSE](https://macfuse.github.io/) - Mac File Integration
-   [OpenMTP](https://openmtp.ganeshrvel.com/) - Mac / Android File Transfer
...
-   [superfile](https://superfile.netlify.app/) - Terminal File Manager
...
-   [FreeBSD Wiki](https://wiki.freebsd.org/) - FreeBSD Wiki / Guides / Docs
-   [GameShell](https://github.com/phyver/GameShell) - Unix Shell Learning Game
-   [Hardware for BSD](https://bsd-hardware.info/) - BSD Hardware Compatibility Database
...
-   [Pkgs](https://pkgs.org/) - Searchable Linux Package Database
-   [Plan9Port](https://9fans.github.io/plan9port/) - Unix Port for Plan9 Libraries + Programs
