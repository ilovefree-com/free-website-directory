...
> Free RSS readers, search engines, password managers, email tools, browser extensions, and internet utilities curated by the FMHY community.

### Internet Tools

-   [byp4xx](https://github.com/lobuhi/byp4xx "byp4xx is a free, web-based utility designed to help users bypass \"403 Forbidden\" HTTP errors. It works by modifying HTTP request headers, such as 'X-Forwarded-For', 'Referer', and 'User-Agent', or by changing the request method (GET/POST). This tool is invaluable for web developers, penetration testers, and security researchers analyzing web application vulnerabilities or accessing restricted content. It operates directly in your browser, requiring no installation.") - Bypass "403 Forbidden" Errors
...
-   [fast](https://fast.com/) - Speed Tests
...
-   [NETworkManager](https://borntoberoot.net/NETworkManager/) - Network Manager
-   [PacketSender](https://packetsender.com/) - Packet Sender
-   [Pinging](https://www.pinging.net/) - Network Testing / Ping Monitors
-   [PortChecker](https://portchecker.co/) - Port Checkers
...
-   [Waveform Test](https://www.waveform.com/tools/bufferbloat) - Test Bufferbloat / Ping Under Load
-   [WiFi Analyzer](https://apps.microsoft.com/store/detail/wifi-analyzer/9NBLGGH33N0N)
-   [WireShark](https://www.wireshark.org/) - Network Protocol Analyzer / Profiles
...
-   [Freedium](https://freedium-mirror.cfd/) - Bypass Medium Paywalls
-   [⁠PressReleased](https://pressreleased.alwaysdata.net/) - Paywall Bypass Tool
-   [wallabag](https://wallabag.org/) - Self-Hosted
...
-   [Linkstack](https://linkstack.org/) - Unlimited / Custom URLs / Self-Hosted
...
-   [OneURL](https://www.oneurl.live/) - Unlimited / Custom URLs / Google Login Required
...
-   [NopeCHA](https://nopecha.com/) - Auto Captcha Solver / Requires Tokens
-   [Privacy Pass](https://github.com/cloudflare/pp-browser-extension) - Save Captcha Tokens
-   [ReCAPTCHA Demo](https://www.google.com/recaptcha/api2/demo) - reCAPTCHA Demos / Get Captcha Tokens

#### Chat Tools

-   [Gajim](https://gajim.org/) - XMPP Clients
-   [Hack.chat](https://hack.chat/) - Minimal / Chats that Work Without Sign-Up
-   [Mumble](https://www.mumble.info/) - Voice Chat
-   [Stoat](https://stoat.chat/) - Communication Platform / Discord Alt / Bots / Resources, 2
-   [Altus](https://github.com/amanharwara/altus) - WhatsApp Clients
-   [Briefing](https://brie.fi/ng) - Video Chat
-   [Chat Analytics](https://github.com/mlomb/chat-analytics) - Generate Chat Analytics
-   [⁠Fluxer](https://fluxer.app/) - Communication Platform / Discord Alt / Servers / Bots / Servers / Bots / Tools / Resources, 2
-   [GoTeam](https://goteam.video/) - Video Chat
-   [Guildbit](https://guildbit.com/) - Voice Chat Servers
-   [Jitsi](https://jitsi.org/) - Video Chat / Web App
...
-   [Miranda NG](https://www.miranda-ng.org/en/) - General Chat Apps
-   [MiroTalk](https://p2p.mirotalk.com/) - Video Chat
-   [Pidgin](https://www.pidgin.im/) - Combine Web Apps / Chat Services
...
-   [WhatsApp-Chat-Exporter](https://github.com/KnugiHK/WhatsApp-Chat-Exporter) - WhatsApp HTML Chat Exporter / Requires Root

#### QR Code Tools

-   [Mini QR](https://mini-qr-code-generator.vercel.app/) - Generator / Customizable
-   [2QR](https://2qr.info/) - Generator
-   [BarcodeScanner](https://gitlab.com/Atharok/BarcodeScanner) - QR / Barcode Scanners
-   [barcodrod.io](https://barcodrod.io/) - Scanner
-   [Binary Eye](https://github.com/markusfisch/BinaryEye) - Scanner
-   [⁠FreeQRApp](https://freeqrapp.com/) - Generator / Customizable
-   [QArt Coder](https://research.swtch.com/qr/draw/) - Generator / Customizable
-   [QR Code Scanner](https://qrcodescan.in/) - Scanner
-   [QRCode Monkey](https://www.qrcode-monkey.com/) - Generator / Customizable
-   [QRcodly](https://www.qrcodly.de/) - Generator / Customizable

### RSS Tools

-   [All about RSS](https://rss.tips/) - RSS Feed / Tool Indexes
...
-   [RSS.app](https://rss.app/) - RSS Feed Search
-   [siftrss](https://siftrss.com/) - RSS Feed Filters

#### RSS Readers

-   [Feedbro](https://nodetics.com/feedbro/) - Browser Extensions
-   [Feedly](https://feedly.com/) - RSS Reader / Multi-Platform / Notifier
-   [Inoreader](https://www.inoreader.com/) - RSS Reader / Multi-Platform / Requires Sign-Up
-   [RSS Guard](https://github.com/martinrotter/rssguard) - RSS Reader / Multi-Platform / Scraper
-   [Feed Flow](https://www.feedflow.dev/) - RSS Reader / Multi-Platform
...
-   [NewsBlur](https://www.newsblur.com/) - RSS Reader / Web-Based
-   [NewsPipe](https://github.com/cedricbonhomme/newspipe) - Self-Hosted RSS Readers
-   [Prodottoinrete](https://freshrss.prodottoinrete.com/i/) - RSS Reader / Web-Based
-   [⁠Tiny Tiny RSS](https://tt-rss.org/) - Docker Based RSS Reader
...
-   [Shodan](https://www.shodan.io/) - Internet Connected Device / Public Assets Search
...
-   [DuckDuckBang](https://mosermichael.github.io/duckduckbang/html/main.html) - DuckDuckGo !bang Meta Search
...
-   [Intelligence X](https://intelx.io/tools) - Multiple Search Tools
...
-   [KeywordSheeter](https://keywordsheeter.com/) - Keyword Research Tools
...
-   [SimilarSiteSearch](https://www.similarsitesearch.com/) - Similar Site Searches
-   [sitedorks](https://github.com/Zarcolio/sitedorks) - Search Engine Dorking Tools
-   [Social-Analyzer](https://github.com/qeeqbox/social-analyzer) - Profile Search CLI
-   [Soovle](https://www.seo.com/soovle/) - Popular Keyword Search
...
-   [Wiby](https://wiby.org/) - Search Engine for Lightweight Web Pages
-   [Yandex Search Operators](https://yandex.com/support/direct/keywords/symbols-and-operators.html "This comprehensive Web-based guide details Yandex search operators, enabling users to construct highly specific queries. It covers syntax for boolean logic (+, -, |, &&), exact phrase matching (\" \"), site/domain restrictions (site:), file type searches (mime:), and more. Ideal for SEO specialists, researchers, and power users seeking to leverage Yandex's full search capabilities for in-depth information retrieval.") - Yandex Search Operator Resources
...
-   [Bing China](https://www.bing.com/?mkt=zh-CN) - Search Engines
-   [Carrot2](https://search.carrot2.org/#/web)
-   [Ecosia](https://www.ecosia.org/) - Plant Trees via Search / Firefox / Chrome
-   [eTools.ch](https://www.etools.ch/)
-   [Fagan Finder](https://www.faganfinder.com/) - Search Engine Indexes
...
-   [Mwmbl](https://mwmbl.org/) - Community Organized Search Engine
-   [OceanHero](https://oceanhero.today/) - Ocean Protection Search Engine
-   [Presearch](https://presearch.com/)
-   [Search All](https://www.searchall.net/) - Multi-Site Search
-   [TheOldNet](https://theoldnet.com/) - Oldschool / Retro Site Search Engines
...
-   [Virgil Game Search](https://virgil.samidy.com/Games/) - Multi-Site Search Engines
-   [Virgil Software Search](https://virgil.samidy.com/Software/) - Multi-Site Software Search
-   [CSE Utopia](https://start.me/p/EL84Km/cse-utopia) - Custom Search Engine Indexes
-   [PastebinSearch](https://cipher387.github.io/pastebinsearchengines/) - Search Pastebins
-   [Rave](https://ravebooksearch.com/) - Multi-Site Book Search
...
-   [Mastering Google Search Operators](https://moz.com/blog/mastering-google-search-operators-in-67-steps) - Google Search Operator Resources
...
-   [Flagfox](https://flagfox.wordpress.com/) - Multi-Tool Firefox Extension for URLs / Full Tools List
-   [lychee](https://lychee.cli.rs/) - URL Scanner
-   [ChangeDetection.io](https://github.com/dgtlmoon/changedetection.io) - Page Change Detection / Notification
...
-   [Linkify Plus Plus](https://greasyfork.org/scripts/4255 "Linkify Plus Plus is a free web browser userscript that dynamically transforms unlinked text URLs (e.g., \"www.example.com\") into active, clickable hyperlinks. It supports various protocols like HTTP/HTTPS, FTP, and mailto, making web content more interactive for users. Ideal for forums, blogs, and social media where URLs might not be automatically linked. Compatible with Greasemonkey/Tampermonkey on Chrome, Firefox, Edge, and Opera.") - Turn Plain Text URLs Into Links
-   [Open Bulk URL](https://openbulkurl.com/) - Bulk Open URLs
-   [scrt.link](https://scrt.link/) - Temporary Single-Use Links
...
-   [Bypass.vip](https://bypass.vip/) - Ad Links Bypasser / Userscript
-   [Evade](https://skipped.lol/evade/evade.user.js) - Ad-Links Bypasser / Site
-   [Adsbypasser](https://adsbypasser.github.io/) - Bypass Link Shorteners
-   [Bypass FREEdlink](https://greasyfork.org/en/scripts/522735 "Bypass FREEdlink \"frdl\" Timers is a userscript designed for web browsers, available on Greasy Fork. It automatically detects and skips the countdown timers found on FREEdlink URL shortener pages, allowing users to access the destination link directly without waiting. This tool enhances browsing efficiency for users who frequently encounter FREEdlink links.") - Bypass FREEdlink "frdl" Timers
-   [Bypass-Links](https://bypass-links.vercel.app/) - Bypass Links
-   [bypass.city](https://bypass.city/) - Bypass Link Shorteners / Userscript
-   [RIP Linkvertise](https://rip.linkvertise.lol/) - Ad-Links Bypasser / Userscript
...
-   [Yuumari](https://yuumari.com/bypass/) - Convert Shortened Links / Script

#### Short Link Tools

-   [WhereGoes](https://wheregoes.com/) - Check Paths of Redirects / Short Links
...
-   [spoo.me](https://spoo.me/) - spoo.me/ZbvUhz
...
-   [Suri](https://github.com/surishortlink/suri) - Self-Hosted Link Shorteners
...
-   [InboxReads](https://inboxreads.co/) - Email Newsletter Archive
-   [Boomerang](https://www.boomeranggmail.com/) - Scheduled Email Sending & Reminders
...
-   [Mailspring](https://getmailspring.com/) - Themes
...
-   [temp-mail.org](https://temp-mail.org/) - Forever / 2 Hours / N/A / Telegram Bot
...
-   [AnonymMail.net](https://anonymmail.net/) - 5 Domains
-   [Bloody Vikings!](https://addons.mozilla.org/en-US/firefox/addon/bloody-vikings/) - Temp Email Extension
-   [CF Temp Mail](https://mail.awsl.uk/en) - Forever / Forever / 5 Domains
...
-   [EduMail](https://edumailfree.com/) - .Edu Addresses
-   [Email Generator](https://generator.email/) - 50+ Domains
-   [EmailOnDeck](https://www.emailondeck.com/) - 1 Domain
-   [Guerrilla Mail](https://www.guerrillamail.com/) - Forever / 1 Hour / 11 Domains / SharkLasers
-   [mail-temp.com](https://mail-temp.com/) - 50+ Domains
...
-   [MinuteInbox](https://minuteinbox.com/) - 10 Minute Lifespan Emails
...
-   [Reusable.email](https://reusable.email/) - Forever / Forever / 1 Domain
...
-   [DuckDuckGo Email Protection](https://duckduckgo.com/email/) - Unlimited Shared / No Catch-All / Send Email / Send From Address / Bitwarden Integration
-   [33mail](https://33mail.com/) - No Shared / 10MB Monthly Bandwidth / Catch-All
-   [addy.io](https://addy.io/) - 10 Shared / 10MB Monthly Bandwidth / Catch-All
...
-   [⁠Email Aliasing Comparison](https://email-aliasing-comparison.pages.dev/)
...
-   [SimpleLogin](https://simplelogin.io/) - 10 Shared / No Catch-All / Send Email

### Browser Bookmarks

-   [Floccus](https://floccus.org/) - Bookmark / Tab Sync
...
-   [linkhut](https://ln.ht/) - Social Bookmarking
-   [SuperMemory](https://supermemory.ai/) - AI Bookmark App

#### Bookmark Managers

-   [Raindrop.io](https://raindrop.io/) - Cross-Platform Manager / TUI
...
-   [Linkwarden](https://linkwarden.app/) - Self-Hosted Managers
...
-   [WebOasis](https://ndsamuelson.github.io/weboas-is/)
...
-   [BrowserBench](https://browserbench.org/) - Browser Benchmark Tests
-   [Browser Comparisons](https://privacytests.org/) - Compare Popular Browsers
-   [⁠Browser Tamer](https://www.aloneguid.uk/projects/bt/) - Multi-Browser Link Redirector & Profile Switcher
...
-   [Gemini Portal](https://geminiprotocol.net/) - Gemini to https Web Proxy Service
...
-   [⁠Just the Browser](https://justthebrowser.com/) - Browser Debloat Script / Guide
-   [Rambox](https://rambox.app/) - Web App Browsers
-   [ThemeBeta](https://www.themebeta.com/) - Change Chrome Theme
-   [VsyncTester](https://vsynctester.com/) - Browser VSYNC Test / Firefox Broken

#### Firefox Tools

-   [arkenfox](https://github.com/arkenfox/user.js) - Firefox Privacy Tweak / Video / GUI
...
-   [r/FirefoxCSS](https://reddit.com/r/FirefoxCSS) - Firefox CSS Resources
...
-   [Audio Download CSE](https://cse.google.com/cse?cx=006516753008110874046:ibmyuhh72io) - Multi-Site Search
-   [Auto Tab Discard](https://webextension.org/listing/tab-discard.html) - Discard Inactive Tabs
-   [Dark Reader](https://darkreader.org/) - Dark Mode
-   [Firefox](https://addons.mozilla.org/en-US/firefox/addon/scroll_anywhere/) - Firefox / Chrome - Improves Scrolling Functionality
-   [Firefox](https://github.com/vord1080/clipboard2file/) - Firefox / Chrome - Upload Images from Clipboard
-   [Stylus](https://add0n.com/stylus.html) - Custom Website Color Schemes
-   [User Styles](https://userstyles.world/) - User Styles, 2 / OLED / Oldschool / Catppuccin
-   [Allow Right Click](https://webextension.org/listing/allow-right-click.html) - Force Enable Right Click
-   [Always Visible](https://webextension.org/listing/always-active.html) - Always Active / On-Top Window
-   [AutoRefresh](https://autorefresh.io/) - Refresh Tabs
...
-   [Bulk URL Opener](https://bulkurlopener.com/) - Open Multiple URLs in One Click
...
-   [Clippings](https://aecreations.io/clippings/index.php) - Clipboard Manager
-   [ColorZilla](https://www.colorzilla.com/) - Color Picker
-   [Consent-O-matic](https://consentomatic.au.dk/) - Block Cookie Consent Popups
...
-   [⁠CRXInstaller](https://addons.mozilla.org/en-US/firefox/addon/crxinstaller/) - Use Chrome Extensions in Firefox Forks, Floorp, Librewolf, etc.
...
-   [Dictionaries](https://github.com/pnlpal/dictionariez) - Popup Dictionaries
-   [Distil](https://distill.io/) - Page Change Detection / Notification
...
-   [Firefox](https://addons.mozilla.org/en-US/firefox/addon/print-edit-we/) - Firefox / Chrome - Edit Pages to Make them Printable
-   [Get-cookies.txt](https://github.com/kairi003/Get-cookies.txt-LOCALLY) - Cookies Exporters
...
-   [Indie Wiki Buddy](https://getindie.wiki/) - Redirect Fandom / Fextralife to Indie Wikis / Redirect List
-   [Link Gopher](https://sites.google.com/site/linkgopher/) - Extract / Copy Links on Webpages
...
-   [PageZipper](https://www.printwhatyoulike.com/pagezipper) - Merges a Sites "Next" Pages
...
-   [Tab Session Manager](https://tab-session-manager.sienori.com/) - Session Managers
-   [Turn Off the Lights](https://www.turnoffthelights.com/) - Play Videos in Theater Mode
...
-   [Vimium](https://vimium.github.io/) - Keyboard Shortcuts
-   [WebExtension.org](https://webextension.org/) - Open-Source Extension Indexes
...
-   [Chrome Mask](https://addons.mozilla.org/en-US/firefox/addon/chrome-mask/) - Use Chrome-Only Sites on Firefox
...
-   [Firefox Color](https://color.firefox.com/) - Custom Firefox Theme Creation
-   [Firefox Containers](https://addons.mozilla.org/en-US/firefox/addon/multi-account-containers/) - Separate Firefox Sessions / Guide
...
-   [Chrome Web Store](https://chromewebstore.google.com/) - Chrome Addon Stores
-   [⁠CRX Downloader](https://crx-downloader.com/) - Chrome Extension Downloader
-   [CrxMouse](https://crxmouse.com/) - Mouse Gestures
-   [Disable All Extensions](https://chromewebstore.google.com/detail/disable-all-extensions/ailfldpmpboolaihojfagmmfbhcgohne)
-   [Extensity](https://chromewebstore.google.com/detail/extensity/jjmflmamggggndanpgfnpelongoepncg) - Extension Managers
-   [Lazy Tabs](https://github.com/jman/lazy_tab) - Auto Discard Inactive Tabs
-   [Linkclump Plus](https://chromewebstore.google.com/detail/linkclump-plus/ainlglbojoodfdbndbfofojhmjbmelmm) - Select, Copy or Open Multiple Links at Once
...
-   [Rearrange Tabs](https://chromewebstore.google.com/detail/rearrange-tabs/ccnnhhnmpoffieppjjkhdakcoejcpbga)
...
-   [Source Downloader](https://mybrowseraddon.com/extension-source-downloader.html) - View Extension Source Code / Guide
-   [TabCopy](https://github.com/hansifer/tab-copy) - Copy Tabs to Clipboard
-   [⁠Tabler](https://tabler.one/) - Tab Managers
-   [Text Blaze](https://blaze.today/) - Create Text Snippets
-   [Text to Image](https://chromewebstore.google.com/detail/text-to-image/nkljaohokglebeljcgchmehnhdieakda)
-   [Transpose](https://transpose.video/) - Online Video Pitch Shifter, Speed Changer and Looper
-   [uAutoPagerize](https://chromewebstore.google.com/detail/kdplapeciagkkjoignnkfpbfkebcfbpb) - Merges a Sites "Next" Pages
...
-   [CSE](https://cizzuk.net/projects/cse/) - Custom Search Engine
-   [PiPifier](https://apps.apple.com/us/app/pipifier/id1234771095) - Picture in Picture Mode
-   [Turn Off the Lights](https://www.turnoffthelights.com/) - Play Videos in Theater Mode

#### Userscripts

-   [Enhancements](https://greasyfork.org/en/scripts/473830) - Enhancements / Helper / Tweaks / Cleanup Script / Themes
-   [Picviewer CE+](https://greasyfork.org/en/scripts/24204) - Image Viewing Tool
-   [⁠ScriptCat](https://docs.scriptcat.org/en/) - Userscript Managers
-   [Always Remember Me](https://openuserjs.org/scripts/Patabugen/Always_Remember_Me) - Always Tick "Remember Me"
-   [Awesome Userscripts](https://github.com/awesome-scripts/awesome-userscripts) - Curated Userscript Indexes
...
-   [Greasy Fork](https://greasyfork.org/) - Userscript Stores
...
-   [CachedView](https://cachedview.nl/) - Aggregate Cache Results
-   [Downloader](https://github.com/jsvine/waybackpack) - Downloader / Browser Extension, 2 / Script / Auto Load
-   [Internet Archive](https://archive.org/) - Video / Audio / Books / Magazines / Newspapers / ROMs / Tools
-   [Wayback Machine](https://web.archive.org/) - Archive Web Pages
-   [Web Archives](https://github.com/dessant/web-archives) - Browser Extensions
...
-   [DownloadNet (dn)](https://github.com/dosyago/dn) - Offline Website Readers
...
-   [ReplayWeb](https://replayweb.page/) - View Web Archive Files
...
-   [Awesome Web Scraping](https://github.com/lorien/awesome-web-scraping) - Web Scraping Tools / Resources
...
-   [Heritrix](https://heritrix.readthedocs.io/) - Internet Archive's Web Crawler
-   [⁠Scrapling](https://github.com/D4Vinci/Scrapling) - Web Scraper
-   [SpiderSuite](https://spidersuite.io/) - Advanced Web Crawler
...
-   [Cyber Detective](https://cybdetective.com/) - Tools, Techniques, and Projects
-   [Harpoon](https://github.com/Te-k/harpoon) - OSINT CLI Tool
-   [Malfrat's OSINT Map](https://map.malfrats.industries/) - Interactive Map
-   [MetaOSINT](https://metaosint.github.io/) - OSINT Search Tool
...
-   [AsINT\_Collection](https://start.me/p/b5Aow7/asint_collection) - General Index
-   [⁠Awesome OSINT For Everything](https://astrosp.github.io/osint-web/) - General Index
-   [Awesome Search Engines](https://github.com/edoardottt/awesome-hacker-search-engines) - OSINT / Cybersecurity Search Engines
-   [Awesome Telegram OSINT](https://github.com/ItIsMeCall911/Awesome-Telegram-OSINT) - Telegram OSINT Indexes
...
-   [OSINT for Countries](https://github.com/wddadk/OSINT-for-countries) - Indexes Organized by Country
...
-   [The Pika's OSINT ToolBox](https://pikaosint.pages.dev/) - General Index
