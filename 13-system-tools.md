...
> Free system utilities, hardware monitors, Windows ISOs, disk tools, and desktop customization tools curated by the FMHY community.

### System Tools

-   [Bulk Crap Uninstaller](https://www.bcuninstaller.com/) - Bulk Uninstallation Tools
-   [CPU-Z](https://www.cpuid.com/softwares/cpu-z.html) - System Info Tools
-   [PowerToys](https://learn.microsoft.com/en-us/windows/powertoys/) - System Tools / Search / Plugins
-   [SuperF4](https://stefansundin.github.io/superf4/) - Process Killers
...
-   [GhostBuster](https://bitbucket.org/wvd-vegt/ghostbuster/src/master/) - Remove Non-Present Devices
...
-   [OpenRecall](https://github.com/openrecall/openrecall) - Memory Search App / System Recorders
...
-   [RegExp](https://github.com/zodiacon/TotalRegistry) - Registry Explorers / Scanners
...
-   [EarTrumpet](https://eartrumpet.app/) - Tweaked Volume Mixer
...
-   [Open Shell](https://open-shell.github.io/Open-Shell-Menu/) - Classic Start Menus
-   [StartAllBack](https://www.startallback.com/) - Tweaked Start Menu & Taskbar / Windows 11 / Fix
-   [Windhawk](https://windhawk.net/) - System Tweaking Tools
-   [⁠AppGroup](https://github.com/iandiv/AppGroup) - Create Taskbar App Groups / Folders
-   [BatUtil](https://github.com/abbodi1406/BatUtil) - System Scripts
...
-   [Kando](https://kando.menu/) - App Launcher / Pie Menu
...
-   [QuickLook](https://github.com/QL-Win/QuickLook) - macOS Quick Look for Windows / Scan Note
-   [RBTray](https://github.com/benbuck/rbtray) - Minimize any App to Tray
-   [Shell](https://nilesoft.org/) - Tweaked / Custom Context Menus
...
-   [Wox](https://github.com/Wox-launcher/Wox) - Keystroke / App Launchers
-   [yasb](https://github.com/amnweb/yasb) - Tweaked Taskbar

#### Package Managers

-   [Scoop](https://scoop.sh/) - Portable Package Manager
-   [sfsu](https://github.com/winpax/sfsu/) - Fast Scoop Utilities
-   [UniGetUI](https://github.com/Devolutions/UniGetUI)
-   [UniGetUI](https://devolutions.net/unigetui/) - GUI for Popular Package Managers
-   [WinGet](https://learn.microsoft.com/en-us/windows/package-manager/winget) - CLI Package Manager / Browse / Auto Update
...
-   [Chocolatey](https://chocolatey.org/) - Package Manager / GUI
...
-   [Awesome CLI Apps](https://github.com/agarrharr/awesome-cli-apps) - Command Line Resources
...
-   [PowerShell Scripts](https://github.com/fleschutz/PowerShell) - Shell Scripts
...
-   [Windows Terminal](https://www.microsoft.com/store/productId/9N0DX20HK701) - Windows Terminal Emulators

#### Remote Desktop

-   [Aspia](https://aspia.org/) - Desktop Client
-   [Parsec](https://parsec.app/) - Desktop Client
-   [RustDesk](https://rustdesk.com/) - Desktop Client
-   [Sunshine](https://app.lizardbyte.dev/Sunshine/) - Remote Server for Moonlight / Mobile
-   [Arcane](https://github.com/PhrozenIO/Arcane) - Desktop Client
-   [Bananas](https://getbananas.net/) - Desktop Client
...
-   [HopToDesk](https://www.hoptodesk.com/) - Desktop Client
-   [InputDirector](https://www.inputdirector.com/) - Multi-Computer Client
-   [Kasm](https://kasm.com/) - Container Streaming Platform / Resource Intensive / Guide
-   [Moonlight](https://moonlight-stream.org/) - Gaming Remote Desktop Client
...
-   [Screego](https://app.screego.net/) - Web-Based
-   [Screen-Sharing](https://share-your-screen.vercel.app/) - Web-Based
-   [Screensy](https://screensy.marijn.it/) - Web-Based
...
-   [CopyQ](https://hluk.github.io/CopyQ/) - Clipboard Managers with Editing and Scripting Features
-   [CrossPaste](https://crosspaste.com/) - Clipboard Manager
-   [PasteBar](https://www.pastebar.app/) - Clipboard Manager
...
-   [WorkSpacer](https://workspacer.org/) - Tiling Window Manager
-   [DWM](https://github.com/prabirshrestha/dwm-win32) - Port of X11 dwm to Windows
-   [⁠Seelen UI](https://github.com/eythaann/Seelen-UI) - Tiling Window Manager
-   [Whim](https://github.com/dalyIsaac/Whim/) - Pluggable Dynamic Window Manager

#### Virtual Machines

-   [QEMU](https://www.qemu.org/) - Virtual Machine / Use w/ Virt-Manager or Vagrantup / Docker Container
-   [Virt-Manager](https://virt-manager.org/) - Virtual Machine Managers
-   [VirtualBox](https://www.virtualbox.org/) - Virtual Machine
-   [VMware Workstation](https://www.techpowerup.com/download/vmware-workstation-pro/) - Virtual Machine / macOS VM
-   [Awesome Web Desktops](https://github.com/syxanash/awesome-web-desktops) - Browser Operating Systems / VMs
...
-   [Looking Glass](https://looking-glass.io/) - Kernel-Based Virtual Machine for VGA PCI Pass-Through
...
-   [WSL](https://learn.microsoft.com/en-us/windows/wsl/) - Run Linux on Windows / Resources / Startup Launcher / Wayland / X Server
...
-   [MemTest](https://www.memtest.org/) - Memory Diagnostic Tools / Usage Trackers
-   [NotCPUCores](https://github.com/rcmaehl/NotCPUCores) - CPU Optimizer
-   [Ozone3D](https://www.ozone3d.net/index_softwares.php) - System Benchmarking
-   [⁠PCI Lookup](https://pcilookup.com/) - PCI Vendor ID Lookup
-   [SDIO](https://glenn.delahoy.com/snappy-driver-installer-origin) - Update / Install Missing Drivers
...
-   [VOGONS Drivers](https://vogonsdrivers.com/) - Vintage Computer Hardware Forum / Forums
...
-   [BatteryMode](https://en.bmode.tarcode.ru/) - System Tray Battery Percentage / Managers
-   [bottom](https://bottom.pages.dev/) - Terminal Hardware Monitors
-   [⁠btop4win](https://github.com/aristocratos/btop4win) - System Info & Monitoring
-   [CoolerControl](https://docs.coolercontrol.org/) - Cooling Device Monitor
-   [FanControl](https://getfancontrol.com/) - PC Fan Controllers
...
-   [Task Manager DeLuxe](https://www.mitec.cz/tmx.html) - Task Manager Alts
-   [Traffic Monitor](https://github.com/zhongyang219/TrafficMonitor/) - Network & Hardware Monitor / Use Lite Version

#### GPU Tools

-   [NVCleanstall](https://www.techpowerup.com/download/techpowerup-nvcleanstall/) - NVIDIA Driver Packages
-   [NVTOP](https://github.com/Syllo/nvtop) - GPU / Accelerator Process Monitor
-   [Display Driver Uninstaller](https://www.wagnardsoft.com/display-driver-uninstaller-ddu-) - Display Driver Removal Tool
-   [nvidiaProfileInspector](https://github.com/Orbmu2k/nvidiaProfileInspector) - Modify / View Hidden NVIDIA Settings / Guide
-   [PresentMon](https://github.com/GameTechDev/PresentMon) - GPU Benchmarking
-   [R.ID](https://rdn-id.com/) - AMD 3rd Party Drivers
...
-   [Universal x86 Tuning Utility](https://amdaputuningutility.com/) - Laptop GPU Controller

#### Disk Tools

-   [CrystalDiskMark](https://crystalmark.info/en/software/crystaldiskmark/) - Disk Benchmarking Tools
-   [Validrive](https://www.grc.com/validrive.htm) - Check True Storage Size of USB Devices
-   [WizTree](https://www.diskanalyzer.com/) - Disk Usage Analyzers
...
-   [CrystalDiskInfo](https://crystalmark.info/en/software/crystaldiskinfo/) - Drive Diagnostics
...
-   [Gdu](https://github.com/dundee/gdu) - Disk Usage Analyzer with Parallel Processing
...
-   [DisplayFusion](https://www.displayfusion.com/) - Dual Monitor Tools
-   [f.lux](https://justgetflux.com/) - Auto-Adjust Display Color / Temperature
-   [Monitorian](https://github.com/emoacht/Monitorian) - Adjust Monitor Brightness
...
-   [Deskreen](https://deskreen.com/) - Use Mobile Device as Monitor
-   [Display Calc](https://www.tools.rodrigopolo.com/display_calc/) - Display Distance / Dimension Calculator
-   [EIZO](https://www.eizo.be/monitor-test/) - Monitor Performance Tests
...
-   [⁠novideo\_srgb](https://github.com/ledoge/novideo_srgb) - Restrict NVIDIA GPUs to sRGB / Prevent Oversaturation
-   [NVDA](https://www.nvaccess.org/download/) - Screen Reader for Blind Users
-   [Scalizer](https://github.com/wonmor/Scalizer-Windows) - Auto DPI Scaling / YouTube
...
-   [geekhack](https://geekhack.org/) - Keyboard Forums
-   [Hotkey Cheatsheet](https://hotkeycheatsheet.com/) - Hotkey Cheatsheets
-   [r/MechanicalKeyboards Wiki](https://www.reddit.com/r/MechanicalKeyboards/wiki/index) - Mechanical Keyboard Recommendations
-   [VIA](https://www.caniusevia.com/) - Custom Keyboard Layouts / Remapping
...
-   [Espanso](https://espanso.org/) - Typing Shortcuts
-   [HotkeyP](https://sourceforge.net/projects/hotkeyp/) - Hotkey Remapping
...
-   [⁠Keebfolio](https://keebfolio.netlify.app/) - Mechanical Keyboard Project Index
-   [Keyboard Simulator](https://keyboardsimulator.xyz/) - Design & Test Virtual Keyboards
-   [⁠Keyboard Tester](https://keyboardtest.io/) - Keyboard Testers
...
-   [MoveMouse](https://github.com/sw3103/movemouse/) - Simulate User Activity
...
-   [AutoEQ](https://autoeq.app/) - Create Custom Equalizer Presets
-   [Equalizer APO](https://sourceforge.net/projects/equalizerapo/) - Audio Equalizers
...
-   [⁠IEM EQ Guide](https://iem-eq-guide.pages.dev/)
...
-   [SoundSwitch](https://soundswitch.aaflalo.me/) - Switch Audio Device with Hotkey
-   [SteelSeries Sonar](https://steelseries.com/gg/sonar) - Noise Cancelling Software
-   [VB-Audio](https://vb-audio.com/Cable/) - Virtual Audio Cable / Select Download on Homepage / Donation is Optional
-   [VoiceMeeter](https://vb-audio.com/Voicemeeter/index.htm) - Audio Mixers / Multi-Device Playback / Banana

### Windows ISOs

-   [Genuine Installation Media](https://massgrave.dev/genuine-installation-media) - Windows ISOs / Clean Install Guide
-   [Windows Install / Debloat Guide](https://wispydocs.pages.dev/windows/)
-   [Fido](https://github.com/pbatard/Fido) - ISO Powershell Script
-   [files.rg-adguard](https://files.rg-adguard.net/) - Verify ISO Legitimacy
-   [Microsoft SD](https://www.microsoft.com/en-us/software-download/) - Windows ISOs / Official Site
-   [⁠MrChromebox](https://docs.mrchromebox.tech/) - Install Windows / Linux on Chromebook
-   [MyDigitalLife](https://forums.mydigitallife.net/) - Windows ISOs / Forums
-   [Old School OS](https://www.oldschoolos.com/) - Oldschool ISOs
...
-   [EtchDroid](https://etchdroid.app/) - Create Bootable USB Drives via Android
...
-   [PC Health Check](https://aka.ms/GetPCHealthCheckApp) - Identify why your PC isn't Ready for Windows 11
-   [UUP Dump](https://uupdump.net/) - Download Previous Windows Updates
...
-   [Hardforum](https://hardforum.com/) - Tech Support Forums
-   [MagNumDB](https://www.magnumdb.com/) - Windows Debugging Tools
-   [Medicat](https://medicatusb.com/) - WinPE / Recovery Toolkits
-   [r/TechSupport](https://www.reddit.com/r/techsupport/) - Tech Support Subreddit
...
-   [Rainmeter](https://www.rainmeter.net/) - Desktop Customization Environments
...
-   [ElectricSheep](https://electricsheep.org/) - Screensavers
...
-   [FluentFlyout](https://fluentflyout.com/) - Modernized Flyout Menus
-   [HackBGRT](https://github.com/Metabolix/HackBGRT) - Boot Logo Changer
-   [MacType](https://www.mactype.net/) - Use Mac Fonts on Windows
-   [MechvibesDX](https://github.com/hainguyents13/mechvibes-dx) - Keyboard Sound Effects
...
-   [SecureUxTheme](https://github.com/namazso/SecureUxTheme) - UX Patcher
-   [⁠Sweezy Cursors](https://sweezy-cursors.com/) - Custom Animated Cursors / Requires no Extension
-   [Taskbar Tweaker](https://tweaker.ramensoftware.com/) - Taskbar Customization / Old School Style
-   [VirtualCustoms](https://virtualcustoms.net/) - Customization Communities
-   [Windows-Ricing](https://github.com/winthemers/wiki) - Windows Customization Resources
-   [Winmoes](https://winmoes.com/) - Anime Windows Themes / Wallpapers
-   [WinSetView](https://lesferch.github.io/WinSetView/) - Globally Set Explorer Folder Views

#### App Themes

-   [Catppuccin](https://catppuccin.com/) - Custom App Theme
-   [Dracula](https://draculatheme.com/) - Custom App Theme
-   [Aura Theme](https://github.com/daltonmenezes/aura-theme) - Custom App Theme
-   [⁠Flexoki](https://stephango.com/flexoki/) - Custom App Theme
...
-   [terminal.sexy](https://terminal.sexy/) - Terminal Themes
...
-   [LWP](https://github.com/jszczerbinsky/lwp) - Live Wallpapers
-   [Studio Ghibli Wallpapers](https://www.ghibli.jp/info/013772)
-   [VSThemes](https://vsthemes.org/en/) - Theme Indexes
-   [wallhaven.cc](https://wallhaven.cc/) - Search Wallpapers / Some NSFW / Downloader
...
-   [G\_Walls](https://t.me/G_Walls) - Telegram Wallpaper Channels
...
-   [WallsPic](https://wallspic.com/) - Misc Wallpapers
-   [WallSync](https://roigoatzzz.netlify.app/) - Wallpaper Site Index
-   [Xbox Wallpapers](https://www.xbox.com/en-us/wallpapers/)

#### Wallpaper Tools

-   [Lively](https://www.rocksdanister.com/lively/) - Live Wallpaper Manager
-   [PKG to Zip](https://github.com/TheRioMiner/Wallpaper-Engine-Pkg-to-Zip) - PKG to Zip / Collections, 2 / Workshop DL
...
-   [Background Switcher](https://johnsad.ventures/software/backgroundswitcher/) - Auto Change Wallpaper
