...
> Free torrent sites, torrent clients, private trackers, and helpful torrenting tools curated by the FMHY community.

### Torrent Sites

-   [Wiki](http://rutracker.wiki/) - Wiki / Rules / Translator / Bypass Extension / Bypass Proxy
-   [1337x](https://1337x.to/home/) - Video / Audio / NSFW / Mirrors
...
-   [rutor.info](https://rutor.is/) - Video / Audio / Books / ROMs / Magazines / Use Translator
-   [Telegram Bot](https://t.me/search_content_bot) - Telegram Bot / IMDb Ratings / Display Magnets / Timestamp Fix
...
-   [0Mag](https://www.0mag.net/) - Magnet Link Sharing Platform
...
-   [Torrentinim](https://github.com/sergiotapia/torrentinim) - Self-Hosted Torrent Search Engines
-   [TorrentProject](https://torrentproject.cc/) - DHT-Based
-   [TorrentQuest](https://torrentquest.com/)
-   [Torrents-CSV](https://torrents-csv.com/)
-   [TorrentSearchRobot](https://t.me/TorrentSearchRoBot) - Telegram Torrent Search Bots
-   [uIndex](https://uindex.org/)

### Torrent Clients

-   [Deluge](https://www.deluge-torrent.org/) - Torrent Client / / Plugins / Config / Telegram Plugin
-   [qBittorrent](https://www.qbittorrent.org/) - Torrent Client / / Tools
-   [rTorrent](https://rakshasa.github.io/rtorrent/) - Torrent Client / / Extended / Tools, 2 / Mods
-   [Transmission](https://transmissionbt.com/) - Torrent Client
-   [BiglyBT](https://www.biglybt.com/) - Torrent Client
-   [BitFlu](https://bitflu.workaround.ch/) - Torrent Client
-   [Distribyted](https://distribyted.com/) - Torrent Client
...
-   [Fragments](https://apps.gnome.org/Fragments/) - Torrent Client
-   [kTorrent](https://apps.kde.org/ktorrent/) - Torrent Client
-   [LIII](https://codecpack.co/download/LIII-BitTorrent-Client.html) - Torrent Client
-   [PikaTorrent](https://www.pikatorrent.com/) - Torrent Client
...
-   [RuTorrent](https://github.com/Novik/ruTorrent) - RTorrent Web Frontends
-   [Seedbox Guide](https://seedboxgui.de/seedbox/) - Seedbox Comparisons
-   [Tixati](https://tixati.com/) - Torrent Client
-   [torrent-control](https://github.com/Mika-/torrent-control) - Easily Send Torrents to Client
-   [WizTorrent](https://wiztorrent.com/) - Torrent Streaming App

#### qBittorrent Tools

-   [Dark Theme](https://draculatheme.com/qbittorrent) - QBT Themes
-   [Docker qBit](https://github.com/linuxserver/docker-qbittorrent) - Docker Builds
...
-   [⁠qui](https://github.com/autobrr/qui) - Web Clients / WebUIs

#### Remote Torrenting

-   [Seedr](https://www.seedr.cc/) - 2GB / Telegram Bot / API Wrapper
-   [TorBox](https://torbox.app/) - Paid / Requires Sign-Up / Unofficial Mobile Client
-   [Multi-Up](https://multiup.io/en/upload/from-torrent) - 10 GB
-   [Torrent\_To\_Google\_Drive\_Downloader](https://colab.research.google.com/github/FKLC/Torrent-To-Google-Drive-Downloader/blob/master/Torrent_To_Google_Drive_Downloader.ipynb) - Google Colab / 15GB
...
-   [OpenSignup](https://opensignup.xyz/) - Tracker Status Updates
...
-   [Private Trackers General](https://claraiscute.neocities.org/Guides/private-trackers) - Private Tracker Guides
-   [r/OpenSignups](https://www.reddit.com/r/OpenSignups/) - Open Tracker Signup Subs
...
-   [Milkie](https://milkie.cc/) - Scene Release Download
-   [PreDB.net](https://predb.net/) - Scene Release Info
-   [T2M](https://nutbread.github.io/t2m/) - Torrent to Magnet Converters
-   [AutoDL-Irssi](https://autodl-community.github.io/autodl-irssi/) - IRC Channel Monitor / Autodownload / Slack Notifications
-   [btcache](https://btcache.me/) - Torrent Storage Cache
...
-   [⁠mkbrr](https://mkbrr.com/) - Torrent Creators
-   [ngosang](https://ngosang.github.io/trackerslist/) - Tracker Lists
