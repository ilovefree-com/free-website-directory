...
> Free video editors, media servers, video downloaders, screen recorders, FFmpeg tools, and live streaming software curated by the FMHY community.

### Video Tools

-   [Reincubate Camo](https://camo.com/studio) - Use Android as Webcam / Live Cam
-   [Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam) - Video Face Swap Tools
-   [Digital Video Intro](https://github.com/leandromoreira/digital_video_introduction) - Digital Video Guides / Resources
-   [ICAT](https://www.nvidia.com/en-us/geforce/technologies/icat/) - Video Quality Comparison & Analysis Tools
-   [Kast](https://kast.gg/) - Online Screen Share
...
-   [ImgBurn](https://www.majorgeeks.com/files/details/imgburn.html) - CD / DVD Burning
-   [MakeMKV](https://www.makemkv.com/) - Create MKV from Blu-ray / DVD / Beta Version, 2
...
-   [Gofile](https://gofile.io/) - 100GB Monthly / Unlimited / 10 Days After Last Download / Manager Export
-   [Byse](https://byse.sx/) - 50GB / 40TB per account / Forever / Requires Sign-Up
...
-   [Streamtape](https://streamtape.com/) - 15GB / Requires Sign-Up / .to
...
-   [FFmpeg](https://ffmpeg.org/) - Audio Converters
...
-   [NEAV1E](https://github.com/Alkl58/NotEnoughAV1Encodes) - AV1 Encoding
-   [selur](https://www.selur.de/) - Video Encoding
-   [Shutter Encoder](https://www.shutterencoder.com/) - File Converter
-   [sickbeard\_mp4\_automator](https://github.com/mdhiggins/sickbeard_mp4_automator) - Automate Video Processing
-   [staxrip](https://github.com/staxrip/staxrip/) - Video Encoding / Contact Sheet + Thumbnails Creator
-   [vvenc](https://github.com/fraunhoferhhi/vvenc) - VVC Encode / Decode
...
-   [FFmpeg Cheat Sheet](https://gist.github.com/steven2358/ba153c642fe2bb1e47485962df07c730) - Command Lists
-   [FFmpeg Libav](https://github.com/leandromoreira/ffmpeg-libav-tutorial) - FFmpeg Guides
-   [FFmpeg-Builds](https://github.com/BtbN/FFmpeg-Builds) - Autobuild Tools
-   [ffmpeg-web](https://ffmpeg-web.netlify.app/) - FFmpeg Web App
...
-   [OBS Studio](https://obsproject.com/)
-   [Streamer.bot](https://streamer.bot/) - Live Stream Manager
-   [Tweaks](https://ctt.cx/video/obs/) - Tweaks / Background Remover / Web App / Phone Controller / Smooth Zoom / Plugin Updater / Guide
-   [Amuse](https://6klabs.com/amuse) - Now Playing Overlays
-   [Awesome Streaming](https://github.com/juancarlospaco/awesome-streaming-tools) - Live Streaming Resources
-   [Chat-Downloader](https://github.com/xenova/chat-downloader) - Retrieve Chat Messages from Livestreams
-   [LiveStreamDVR](https://github.com/MrBrax/LiveStreamDVR) - Live Stream Recorder
-   [⁠MeldStudio](https://meldstudio.co/) - Live Stream Manager
...
-   [ppInk](https://github.com/PubPub-zz/ppInk/) - Screen Annotation
...
-   [⁠TikFinity](https://tikfinity.zerody.one/) - TikTok Live Toolkit
...
-   [VSeeFace](https://www.vseeface.icu/) - 3D Tracking & Puppeteering (VRM)
-   [VTResources](https://vtresources.carrd.co/) - VTuber Resources
-   [Vtube Studio](https://denchisoft.com/) - 2D / Live2D Tracking
-   [VTuber Assets](https://discord.gg/acU3dFRtvC) - VTuber Resources
-   [VTuber Kit](https://kyuppin.itch.io/vtuber-kit) - VTuber Character Creators / Tracking
-   [VTuberized Logos](https://vtuber-style-logos.vercel.app/) - VTuber Style Logos

### Video Players

-   [FastStream](https://faststream.online/) - Fragmentation Streaming Extension / Android / Firefox Note
-   [MPC-HC](https://github.com/clsid2/mpc-hc/) - Video Player / YT-DL Support
-   [MPV Clients](https://mpv.rocks/) - Video Player / Custom Builder / Frontends
-   [OpenVideo](https://openvideofs.github.io/) - Use Streaming Sites in Ad-Free Player with Subs, Speed Control & More
-   [VLC](https://www.videolan.org/) - Video Player
-   [AVPlayer](http://www.awesomevideoplayer.com/) - Multi-Video Players
-   [Awesome Video](https://github.com/krzemienski/awesome-video) - Video Streaming Resources
-   [Codec Guide](https://www.codecguide.com/) - Video Player Codec Collections
...
-   [PotPlayer](https://potplayer.tv/) - Video Player / Twitch Addon / YouTube Addon
...
-   [SMPlayer](https://www.smplayer.info/) - Video Player / SMTube
-   [SPlayer](https://www.splayer.org/) - Video Player with Smart Translation
-   [StreamLink](https://streamlink.github.io/) - Extract Videos from Sites to Players / Twitch Adblock
...
-   [neko](https://neko.m1k1o.net/) - Docker Virtual Browser
...
-   [HyperBeam](https://hyperbeam.com/) - Virtual Computer Embed
-   [Metastream](https://getmetastream.com/) - Online Extension
-   [MovieNight](https://github.com/zorchenhimer/MovieNight) - Docker
-   [OpenTogetherTube](https://opentogethertube.com/) - Online Player
-   [Rave.io](https://rave.io/) - Online Extension
-   [VideoTogether](https://2gether.video/en-us/) - App

#### MPV Tools

-   [ArtCNN](https://github.com/Artoriuz/ArtCNN) - Anime Upscaling
...
-   [FSR](https://gist.github.com/agyild/82219c545228d70c5604f865ce0b0ce5) - AMD FidelityFX port
...
-   [ModernZ](https://github.com/Samillion/ModernZ) - Alt User Interfaces
-   [MPV Config Guide](https://thewiki.moe/tutorials/mpv/)
...
-   [MPV SponsorBlock](https://github.com/po5/mpv_sponsorblock) - SponsorBlock for MPV
...
-   [Play With MPV](https://greasyfork.org/en/scripts/416271) - Open Videos with MPV
...
-   [VideoClip](https://github.com/Ajatt-Tools/videoclip) - Clip Tool
...
-   [Dispatcharr](https://github.com/Dispatcharr/Dispatcharr) - IPTV Playlist Managers for Servers
...
-   [Plex](https://www.plex.tv/) - Media Server / Tools
-   [Prowlarr](https://prowlarr.com/) - Autodownload Tools
-   [Reiverr](https://github.com/aleksilassila/reiverr) - Media Server Manager
-   [Seerr](https://github.com/seerr-team/seerr) - User Request Management
...
-   [TRaSH Guides](https://trash-guides.info/) - Server Setup Guides
-   [Tunarr](https://tunarr.com/) - Custom Live Channel Servers
...
-   [YTDL-Sub](https://ytdl-sub.readthedocs.io/en/) - Add YouTube Channels to Media Servers

#### Plex Tools

-   [Kitana](https://github.com/pannal/Kitana) - Plugin Frontend
-   [Overseerr](https://overseerr.dev/) - User Requests / IMDb Extension
...
-   [Fladder](https://github.com/DonutWare/Fladder/) - Desktop Client
...
-   [Findroid](https://github.com/jarnedemeulemeester/findroid) - JellyFin Android Clients
-   [Jellyfin "arr" Setup Guide](https://www.fuzzygrim.com/posts/media-server "This free web guide details the integration of Jellyfin, an open-source media server, with the \"arr\" suite (Sonarr, Radarr, Lidarr) for automated downloading, organizing, and streaming of movies, TV shows, and music. Ideal for users seeking a robust, self-hosted media solution on various platforms.")
...
-   [Kodi Skins](https://kodi.tv/addons/omega/category/skins/)
-   [Plex Kodi Connect](https://github.com/croneter/PlexKodiConnect) - Plex for Kodi
-   [quasar](https://quasar.surge.sh/) - Torrent Plugin
-   [r/Addons4Kodi](https://www.reddit.com/r/Addons4Kodi/) - Kodi Addons
...
-   [9xbuddy](https://9xbuddy.com/) - Multi-Site / Online
-   [yt-dlp](https://github.com/yt-dlp/yt-dlp) - YouTube CLI Downloader / Commands
-   [CD(R)M-Project](https://cdm-project.com/explore/repos) - DRM Tools
...
-   [hls-downloader](https://github.com/puemos/hls-downloader) - HLS Downloaders
-   [⁠imov.life](https://imov.life/) - Multi-Site / Online
-   [iTeraPlay](https://iteraplay.com/) - ⁠TeraBox Video Downloaders
-   [Musvkrobot](https://t.me/musvkrobot) - Video Downloader
-   [NeoDLP](https://neodlp.neosubhamoy.com/) - Multi-Site / Extension
...
-   [SCrawler](https://github.com/AAndyProgram/SCrawler) - Multi-Site / Software
-   [SSSTik](https://ssstik.io/) - TikTok
-   [Threads Downloader](https://threadsdownloader.com/) - Threads
-   [Video DownloadHelper](https://www.downloadhelper.net/) - Extensions
...
-   [⁠YT-DLP Online](https://ytdlp.online/)

### Video Editing

-   [Eyecandy](https://eyecannndy.com/) - Visual Technique Examples
-   [r/VideoEditing](https://www.reddit.com/r/VideoEditing/) - Video Editing Subreddit / Wiki
-   [Waifu2x GUI](https://github.com/AaronFeng753/Waifu2x-Extension-GUI) - Video Upscaling
...
-   [DaVinci Resolve](https://www.blackmagicdesign.com/products/davinciresolve) - Video Editor / Requires Sign-Up (Fake Info Works) / Guides / Subtitle Generator / Green Screen Extract
...
-   [avisynth](http://avisynth.nl/index.php/Main_Page) - Video Processors
-   [FreeMoCap](https://freemocap.org/)
-   [GOA PsyTrance Livesets](https://rentry.co/FMHYB64#goa-psytrance-livesets) - DJ Livesets
-   [Kurku](https://app.kurku.tech/) - Motion Tracking Tools
...
-   [Source Filmmaker](https://store.steampowered.com/app/1840/Source_Filmmaker/) - Steam Movie-Making Tool / Resources
-   [suckless-cut](https://github.com/couleur-tweak-tips/suckless-cut) - Cut / Trim Videos
...
-   [FreeCut](https://www.freecut.net/)
-   [Klippy](https://www.klippy.pro/)
-   [LoopVid](https://loopvid.kastden.org/) - Loop Videos
-   [Omniclip](https://omniclip.app/)
...
-   [blur](https://github.com/f0e/blur) - Add Motion Blur to Videos / Tutorial
-   [CorridorKey](https://github.com/nikopueringer/CorridorKey) - AI Green Screen Extraction Tool / Unmixing / High VRAM Requirements / DaVinci Plugin / GUI
-   [Flowframes](https://nmkd.itch.io/flowframes) - Video Interpolation / Increase FPS
-   [FreshLUTs](https://freshluts.com/) - Free LUTs (Color Filters)
-   [Gyroflow](https://gyroflow.xyz/) - Video Stabilization
-   [⁠ntsc-rs](https://ntsc.rs/) - TV + VHS Artifact Video Effect Editor / Web Version
...
-   [Download Pirate](https://www.downloadpirate.com/) - Use Adblock
-   [flex\_cg\_vfx](https://t.me/flex_cg_vfx)
...
-   [Modding Guides](https://github.com/Dmgvol/UE_Modding) - Modding Guides / Megascans / Model Viewer / UPK Explorer / Wiki
-   [Unreal Engine](https://www.unrealengine.com/) - 3D Creation Tools
...
-   [AnimeEffects](https://github.com/AnimeEffectsDevs/AnimeEffects) - 2D Animation Tools
-   [⁠Autograph](https://www.maxon.net/en/autograph) - Motion Graphics Editors / Animation Tools
-   [BestSnip](https://bestsnip.com/animation/) - Online Animation Tools
...
-   [Glaxnimate](https://glaxnimate.mattbas.org/) - Vector Animation Tools
-   [JWildfire](https://jwildfire.overwhale.com/) - Flame Fractal Rendering Software
-   [LibreSprite](https://libresprite.github.io/) - Pixel Art Editor
-   [LuxCoreRender](https://luxcorerender.org/) - Rendering Engine
-   [Mandelbulber](https://mandelbulber.com/) - Fractal Rendering Software / 3D
-   [Mega Scans](https://quixel.com/megascans) - 3D Scans
-   [Mixamo](https://www.mixamo.com/) - 3D Character Animation Tools
...
-   [Viggle](https://viggle.ai/) - Animated Character Creators
