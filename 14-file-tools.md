...
> Free file management tools, PDF editors, file converters, cloud storage, and file transfer services curated by the FMHY community.

### File Tools

-   [czkawka](https://github.com/qarmin/czkawka) - Duplicate File Finders
-   [⁠copyparty](https://github.com/9001/copyparty/) - Portable File Server
-   [ExampleFile](https://www.examplefile.com/) - Dummy Example Files
-   [HTTPDirfs](https://github.com/fangfufu/httpdirfs) - HTTP File Systems
...
-   [UnLock IT](https://emcosoftware.com/unlock-it/download) - File Unlocker / Deleter
-   [WinBtrfs](https://github.com/maharmstone/btrfs) - Btrfs File System

#### Download Managers

-   [AB Download Manager](https://abdownloadmanager.com/) - Download Manager
-   [Debloat Guide](https://claraiscute.neocities.org/Guides/jdownloader2/) - Debloat Guide, 2 / Apps / Dark Theme, 2 / Dracula Theme
-   [aria2](https://aria2.github.io/) - Terminal Download Manager / Download Bot / WebUI, 2
-   [ArrowDL](https://www.arrow-dl.com/) - Download Manager / Firefox / Chrome
-   [⁠Brisk](https://github.com/BrisklyDev/brisk) - Download Manager / Extension
-   [DownThemAll](https://www.downthemall.org/) - Download Management Extension / Firefox / Chrome
-   [FDM](https://www.freedownloadmanager.org/) - Download Manager / YTDL Addon / Firefox / Chrome
...
-   [HTTP Downloader](https://erickutcher.github.io/) - Download Manager for HTTP / FTP / SFTP / Firefox / Chrome
-   [imFile](https://imfile.org/)
-   [JDownloader](https://jdownloader.org/jdownloader2) - File Download Manager / Debloat / Dark Theme, 2 / Dracula Theme
-   [Persepolis](https://persepolisdm.github.io/) - Download Manager
-   [pyLoad](https://pyload.net/) - Lightweight Download Manager
-   [⁠Surge](https://github.com/surge-downloader/surge) - TUI Download Manager / Firefox
-   [Varia](https://github.com/giantpinkrobots/varia) - Download Manager / Firefox / Chrome
...
-   [Efficient Compression Tool](https://github.com/fhanau/Efficient-Compression-Tool) - File Archivers / Optimizers
-   [ezyZip](https://www.ezyzip.com/) - Zip Files Online
-   [Fileforums](https://fileforums.com/) - Data Compression Forums
-   [ouch](https://crates.io/crates/ouch) - Archiving / Compression CLI
...
-   [UPX](https://upx.github.io/) - Executable File Compressor
-   [WinRAR](https://www.win-rar.com/) - File Archiver / Hide Popups

#### File Converters

-   [Aconvert](https://www.aconvert.com/) - Online / Various Converters / 40MB
-   [Convert to it!](https://p2r3.github.io/convert/) - Offline / File Converter
-   [File Converter](https://file-converter.io/) - Offline / Convert & Compress Files
-   [VERT](https://vert.sh/) - Online for Videos / Offline for Other Formats
...
-   [Deark](https://entropymine.com/deark/) - Decode and Convert Files
-   [⁠Docling](https://docling-project.github.io/docling/) - Document / PDF File Converters
-   [⁠Docpose](https://docpose.cloud/convert) - Online / File Converter / 25MB
...
-   [Shutter Encoder](https://www.shutterencoder.com/) - File Converter
-   [text2img](https://master.ayra.ch/text2img/) - Local NFO Files to Image Converter
...
-   [DoubleCMD](https://doublecmd.sourceforge.io/) - Cross-Platform File Managers
-   [Explorer++](https://explorerplusplus.com/) - Lightweight Windows File Manager
-   [eza](https://eza.rocks/) - Modern ls Replacements
-   [Far Manager](https://www.farmanager.com/) - File / Archive Manager
-   [FileBrowser Quantum](https://filebrowserquantum.com/) - Self-Hosted Web File Manager
-   [Files](https://files.community/) - Customizable File Manager / Use Classic Installer
-   [Free Commander](https://freecommander.com/) - File Manager
-   [One Commander](https://www.onecommander.com/) - File Manager
-   [Sigma](https://sigma-file-manager.vercel.app/) - Modern File Manager
-   [SoftwareOK](https://www.softwareok.com/) - Freeware Directory
-   [superfile](https://superfile.netlify.app/) - Terminal File Manager
-   [TablacusExplorer](https://tablacus.github.io/explorer_en.html) - Tab File Managers
...
-   [Everything](https://voidtools.com/) - File Search Engine / Alpha / Date Searching
-   [AnyTXT](https://anytxt.net/) - Windows Search Engines
-   [AstroGrep](https://sourceforge.net/projects/astrogrep/) - Windows GUI Grep Utilities
...
-   [Recoll](https://www.recoll.org/) - Cross-Platform Search Engines
-   [sist2](https://github.com/simon987/sist2) - Simple Incremental Search Tool

#### File Encryption

-   [Cryptomator](https://cryptomator.org/) - Cloud File Encryption
...
-   [SyncThing](https://syncthing.net/) - Cross-Platform File Sync / Android / Tray Support
-   [allwaysync](https://allwaysync.com/) - File Sync Utility
-   [MyPhoneExplorer](https://www.fjsoft.at/) - Phone and Desktop Sync
-   [Resilio](https://www.resilio.com/individuals/) - P2P File Sync
-   [rsync](https://rsync.samba.org/) - Command-line File Sync
...
-   [Rescuezilla](https://rescuezilla.com/) - Disk Image Backup
...
-   [Borg](https://www.borgbackup.org/) - De-duplicating File Backup / WebUI
...
-   [MultiPar](https://github.com/Yutaka-Sawada/MultiPar) - Prevent File Corruption / Guide
-   [PhotoRec](https://www.cgsecurity.org/wiki/PhotoRec) - File Recovery
-   [ShadowExplorer](https://www.shadowexplorer.com/) - Shadow Copy Explorers
-   [Windows File Recovery](https://apps.microsoft.com/detail/9n26s50ln705) - File Recovery

#### File Info / Metadata

-   [Fileinfo](https://fileinfo.com/) - File Extension Libraries
...
-   [ExtractMetadata](https://www.extractmetadata.com/) - Metadata Viewers / Editors
-   [Magika](https://github.com/google/magika) - File Type Detection Tools
-   [MediaInfo](https://mediaarea.net/en/MediaInfo) - Media File Analysis / Metadata Viewer / Online
-   [MediaPeek](https://mediapeek.plnk.workers.dev/) - Online Media File Analysis / Metadata Viewer
-   [⁠PrivMeta](https://www.privmeta.com/) - Remove Metadata from Files
-   [SKTimeStamp](https://tools.stefankueng.com/SKTimeStamp.html) - Change File Created / Modified Time
-   [TagSpaces](https://www.tagspaces.org/) - Tag-Based File Systems
...
-   [Eraser](https://eraser.heidi.ie/) - File Shredding
-   [Low Level Format](https://www.lowlevelformat.info/) - Complete Hard Drive Erasers
...
-   [Advanced Renamer](https://www.advancedrenamer.com/) - Bulk Renamers
-   [FileBot](https://www.filebot.net/) - Media File Renaming
-   [FoliCon](https://dineshsolanki.github.io/FoliCon/) - Automatic Custom Media Icons / Folders
-   [MediaMonkey](https://www.mediamonkey.com/) - Media Organizer
-   [Shoko](https://github.com/shokoanime) - Anime File Data Automation
-   [tinyMediaManager](https://www.tinymediamanager.org/) - Media Collection Managers
...
-   [OpenSign](https://github.com/OpenSignLabs/OpenSign) - PDF Signature Tools
-   [PDF Bookmark Editor](https://mrfragger.github.io/pdf-bookmark-editor/)
...
-   [BentoPDF](https://bentopdf.com/) - Client-Side
...
-   [PDFCraft](https://pdfcraft.devtoolcafe.com/) - Client-Side
...
-   [Issuu](https://issuu.com/) - Convert PDF Files to Webpages, Flipbooks, Brochures & More / Downloader
...
-   [Rare2PDF](https://rare2pdf.com/) - File to PDF Conversion
-   [⁠Tideflow](https://github.com/BDenizKoca/Tideflow-md-to-pdf) - Markdown to PDF Converters
-   [WebToPDF](https://webtopdf.com/) - Webpage to PDF Converters

### File Transfer

-   [Blip](https://blip.net/) - Hybrid / Turn "Searchable by Name" Off in Settings
-   [LocalSend](https://localsend.org/) - Local / All Platforms
-   [aQRoss](https://aqross.app/)
-   [croc](https://github.com/schollz/croc) - Online / / GUI
-   [FilePizza](https://file.pizza/) - Online
-   [FileZilla](https://filezilla-project.org/download.php?show_all=1) - FTP Client
-   [IPFS](https://ipfs.tech/) - Desktop / Mobile Transfer
-   [KDE Connect](https://kdeconnect.kde.org/) - Local / All Platforms / Source
-   [LANDrop](https://landrop.app/) - Local / All Platforms
-   [Magic Wormhole](https://github.com/magic-wormhole/magic-wormhole) - Online
-   [NahrajSoubor](https://new.nahrajsoubor.cz/) - Online
-   [OnionShare](https://onionshare.org/) - Share Files Over Tor Network
-   [⁠Phone Link](https://www.microsoft.com/windows/sync-across-your-devices) - Hybrid
-   [Photon](https://photondev.netlify.app/) - Local
-   [Resources](https://awesome.ipfs.tech/) - Resources, 2 / Extension / Desktop / IPFS Cluster
-   [⁠robocopy](https://learn.microsoft.com/windows-server/administration/windows-commands/robocopy) - Windows Built-In File Transfer Guide / WebUI
-   [Sefirah](https://github.com/shrimqy/Sefirah) - Local
-   [⁠Sendme](https://www.iroh.computer/sendme) - P2P File Transfer CLI
-   [WinSCP](https://winscp.net/eng/index.php) - FTP Client
-   [Wormhole](https://wormhole.app/) - Online

#### P2P Transfer

-   [JustBeamIt](https://justbeamit.com/) - Web
-   [Pairdrop](https://pairdrop.net/) - File Sharing
-   [⁠Clip Fish](https://clip.fish/) - Web
-   [new.space](https://new.space/) - Web, iOS
-   [⁠Station307](https://www.station307.com/) - Web
-   [Surge](https://getsurge.io/) - P2P App
-   [ToffeeShare](https://toffeeshare.com/) - Web
-   [WebWormhole](https://webwormhole.io/) - Chrome / Firefox / Web

### File Hosts

-   [Buzzheavier](https://buzzheavier.com/) - Unlimited / 7 Day Expiry / +1 Hour Per DDL / File Expiry
-   [Pillowcase](https://pillows.su/) - Audio File Host / 200MB (500MB w/ Account) / Forever
-   [Pixeldrain](https://pixeldrain.com/) - 10GB / 60 Days After Last Download (10% min) / Mirrors / Speedtest / Bypass
-   [⁠Rootz](https://rootz.so/) - 25GB / 15 Days After Last Download / Account Required / Unlimited for Backstage Users / Use Adblocker
-   [VikingFile](https://vikingfile.com/) - Unlimited / 15 Days After Last Download / Use Adblocker
-   [⁠ZeroFS](https://zerofs.link/) - Unlimited / 15 Days After Last Download / CLI
-   [1fichier.com](https://1fichier.com/) - 300GB / 15 Days (30 Days w/ Account)
-   [Akira Box](https://akirabox.com/) - 20GB Free / 30 Days After Last Download
-   [Awesome File Hosts](https://fhhy.vercel.app/) - File Host Indexes
...
-   [DataNodes](https://datanodes.to/) - Webmasters Only File Host / Use Adblocker
...
-   [Fast File](https://fast-file.com/) - 10GB / 20 Days After Last Download / Status
-   [file.kiwi](https://file.kiwi/) - Unlimited / 90 Hours / File Expiry
-   [Filebin](https://filebin.net/) - Unlimited / 6 Days
-   [FileDitch](https://new.fileditch.com/) - 25GB / 90 Days
...
-   [FileQ](https://fileq.net/) - 50GB / 20GB / 3 Days After Last Download / Has Unlimited Plans
...
-   [hostb](https://hostb.org/) - Unlimited / 30 Days After Last Download
...
-   [MultiUp.io](https://multiup.io/) - Multi Host Uploaders
-   [pCloud Transfer](https://transfer.pcloud.com/) - 5GB / 7 Days / Requires Email
-   [⁠Pearcrypt](https://pearcrypt.lol/) - File Link Containers
-   [⁠PolyUploader](https://polyuploader.vercel.app/) - Multi-Host Upload Desktop Apps
-   [Ranoz](https://ranoz.gg/) - 20GB / 30 Days After Last Download
-   [Send](https://send.vis.ee/) - 2.5GB / 3 Days / 10 Downloads / CLI / Instances
...
-   [MEGA](https://mega.io/) - 20GB / 3 Months / ~$1.72 (20TB Pro III)
...
-   [Eylenburg Comparisons](https://eylenburg.github.io/cloud_comparison.htm) - Compare Cloud Storage Sites
...
-   [Proton Drive](https://proton.me/drive) - 5GB / 1 Year / ~$6.66 (3TB Workspace Premium) / / Note
...
-   [Rclone](https://rclone.org/) - Cloud Storage Manager / Guide / GUI / Colab / Transfer Tool
-   [FileStash](https://www.filestash.app/) - File Manager
...
-   [gdurl](https://gdurl.com/) - GDrive Link Generators / Host Direct Links
-   [GOA PsyTrance Livesets](https://rentry.co/FMHYB64#goa-psytrance-livesets) - DJ Livesets
-   [goindex-extended](https://github.com/menukaonline/goindex-extended) - Google Drive Indexers
...
-   [Google Drive Clone Bot](https://jsmsj.github.io/GdriveCloneBot/) - Copy Google Drives
...
-   [GOA PsyTrance Livesets](https://rentry.co/FMHYB64#goa-psytrance-livesets) - DJ Livesets
-   [MEGA CMD](https://mega.io/cmd) - Official CLI App
-   [MEGA Desktop](https://mega.io/desktop) - Official GUI App
