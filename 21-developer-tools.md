...
> Free developer communities, IDEs, code editors, API tools, Git tools, web development resources, and programming tools curated by the FMHY community.
...
-   [Lobsters](https://lobste.rs/) - Dev News / Highlighter
...
-   [Free for Developers](https://free-for.dev/) - Tool Index
...
-   [Beszel](https://beszel.dev/) - Dev Data Dashboard / iOS App
...
-   [Free For Life](https://free.hrsn.dev/) - Tool Index
...
-   [PuTTY](https://www.chiark.greenend.org.uk/~sgtatham/putty/) - SSH & Telnet Client / Multi-Tab
...
-   [Tiny Helpers](https://tiny-helpers.dev/) - Tool Index
-   [Tiny Tools](https://tinytools.directory/) - Tool Index
-   [Useful Tools](https://trolologuy.github.io/useful-tools/) - Tool Index
...
-   [App Store](https://www.electronjs.org/apps/) - App Store / Debugger / Builder
...
-   [Baserow](https://baserow.io/) - Database Manager / Requires Sign-Up
...
-   [Codeberg](https://codeberg.org/) - Git Hosting Services
...
-   [Podman](https://podman.io/) - Root-less, Daemon-less, Open Source Docker Alternative / / Compose
...
-   [WatchTower](http://watchtower.nickfedor.com/) - Container Automation
...
-   [sshx](https://sshx.io/) - Share Terminal Screen
...
-   [Shizuku](https://shizuku.rikka.app/) - Let Apps Use System API
...
-   [⁠CoorenLabs](https://coorenlabs.com/) - Piracy Site Metadata APIs / Scraping
...
-   [Wyzie Subs](https://sub.wyzie.ru/) - Subtitle Scraping API / NPM Package / Docs
...
-   [Xelu's Controller Prompts](https://thoseawesomeguys.com/prompts/) - Free Game Prompts / Video
...
-   [⁠Fortnite Porting](https://fortniteporting.app/) - Extract Fortnite Assets
...
-   [Bleeper](https://pixwlk.itch.io/bleeper) - Game Sound Effects Creators
...
-   [Sprite Fusion](https://www.spritefusion.com/) - Tilemap Editors
...
-   [Emacs](https://www.gnu.org/software/emacs/) - Code Editor / Resources
-   [JetBrains](https://jetbrains.com/)
-   [Lite XL](https://lite-xl.com/) - Code Editor / Plugin Manager / Plugins / Themes
-   [Neovim](https://neovim.io/) - Code Editor / Matrix
-   [VSCodium](https://vscodium.com/) - Code Editor / Tools / Extensions
...
-   [Bluefish](https://bluefish.openoffice.nl/index.html) - Code Editor / Templates
...
-   [Atheos](https://www.atheos.io/) - Requires Server / Cloud IDE
...
-   [Codeface](https://github.com/chrissimpkins/codeface) - Fonts for Coding / Comparison
...
-   [DogBolt](https://dogbolt.org/) - Decompiler Explorers
...
-   [AI SDK](https://sdk.vercel.ai/) - Coding AI
-   [Ampcode](https://ampcode.com/) - Coding AI
-   [Cline](https://cline.bot/) - Autonomous VS Code Agents
-   [Code Web Chat](https://codeweb.chat/) - Coding AI / No Sign-Up
-   [Continue](https://continue.dev/) - Coding AI
-   [Gemini CLI](https://geminicli.com/) - Coding AI / Gemini 3 Flash/Pro
-   [getdesign.md](https://getdesign.md/) - AI-Ready Design Systems
-   [GitWit](https://gitwit.dev/) - Coding AI
-   [GOA PsyTrance Livesets](https://rentry.co/FMHYB64#goa-psytrance-livesets) - DJ Livesets
-   [⁠Google Antigravity](https://antigravity.google/) - Coding AI / Gemini 3 / Claude Opus 4.6 / Limits Reset Weekly / Add Skills / Usage Tracker
-   [Open Interpreter](https://github.com/OpenInterpreter/open-interpreter) - Local Code Interpreter / No Sign-Up
-   [OpenCode](https://opencode.ai/) - Coding AI / GPT-5 nano / Minimax-M2.5 / Resources
-   [OpenHands](https://www.all-hands.dev/) - Coding AI
-   [Qodo](https://www.qodo.ai/) - Coding AI
-   [Supermaven](https://supermaven.com/) - Tab Completion Coding AI / No Sign-Up
-   [Windsurf](https://www.windsurf.com/) - Agentic IDE With Tab Completion

#### AI Web Coding

-   [Qwen](https://chat.qwen.ai/) - Qwen3.6-Plus / Qwen3.5-Plus / Sign-Up
-   [⁠Z.ai](https://chat.z.ai/) - GLM-5.1 / GLM-5-Turbo / Slides
-   [AI Studio](https://aistudio.google.com/app/apps) - Gemini 3.1 Pro / Google Sign-Up / Coding AI
-   [Arena](https://arena.ai/code) - Multiple Coding AI / Multiple Models / Sign-Up (Direct mode) / Reset Limits w/ Temp Mail / OpenAI Bridge
...
-   [Kimi](https://www.kimi.com/agent) - Kimi K2.6 (Thinking) / Coding AI / Google Login or Phone # Required
...
-   [The Algorithms - C++](https://thealgorithms.github.io/C-Plus-Plus) - C++ - C++ Algorithms
...
-   [Recaf](https://www.coley.software/Recaf/) - Java Bytecode Editor / GUI
...
-   [APlayer](https://aplayer.js.org/) - HTML5 Video Players
...
-   [Puck](https://puckeditor.com/) - Create Simplified Visual Editors for Non-Devs
...
-   [cURL](https://curl.se/) - HTTP Clients / Transfer Data with URLs / Converter / IP Lookup / Recipes
-   [Dagu](https://dagu.cloud/) - WebUI Job Manager
...
-   [PocketBase](https://pocketbase.io/) - Open-Source Backend Platforms
...
-   [shadcn-ui](https://ui.shadcn.com/) - Web Component Libraries / Examples
...
-   [uMap](https://umap-project.org/) - Custom Embeddable Maps for Websites
-   [Wappalyzer](https://www.wappalyzer.com/) - Identify Technologies on Websites / Addons
...
-   [Docusaurus](https://docusaurus.io/) - Static Markdown Website Generators
...
-   [Awesome Static Generators](https://myles.github.io/awesome-static-generators/) - Static Site Generator Indexes
...
-   [Retype](https://retype.com/) - Static Markdown Website Generator
...
-   [Beer CSS](https://www.beercss.com/) - Lightweight CSS Framework
-   [Bootstrap](https://getbootstrap.com/) - Mobile Site Creator / Icons / Snippets / UI Components / Templates, 2
...
-   [CSS Bed](https://www.cssbed.com/) - Classless CSS Templates
...
-   [Icon Horse](https://icon.horse/) - Download a Site's Favicon
...
-   [SaaS Pages](https://saaspages.xyz/) - Landing Page Templates / Ideas
...
-   [WebDesigner](https://webdesigner.withgoogle.com/) - Create Motion Graphics
...
-   [Melody](https://yoav-lavi.github.io/melody/book/) - Compile to Regex
...
-   [LightTest](https://lightest.app/) - Test Webpage Speed
-   [Accessibility Insights](https://accessibilityinsights.io/) - Fix Accessibility Issues
-   [⁠ADG](https://www.accessibility-developer-guide.com/) - Site Accessibility Guidelines
...
-   [Pa11y](https://pa11y.org/) - Accessibility Evaluation Tools
-   [Prometheus](https://prometheus.io/) - Site Metrics / Setup
-   [Rankchart](https://rankchart.org/) - Optimization Reports
-   [Responsive Viewer](https://responsiveviewer.org/) - Test Site on Multiple Screen Types / Chrome
-   [Responsively](https://responsively.app/) - Website Responsiveness Tests
...
-   [Web Vitals Leaderboard](https://vitals-leaderboard.pazguille.me/) - Website Performance Tests

#### SVG Tools

-   [⁠3DSVG](https://3dsvg.design/) - 3D SVG Editor
-   [AutoTracer](https://www.autotracer.org/) - Image Vectorizers / Autotracers
...
-   [FrameSVG](https://framesvg.romelium.cc/) - GIF to Animated SVG
...
-   [SVGO](https://github.com/svg/svgo) - SVG Optimization / GUI
-   [SVGX](https://svgx.app/) - SVG Assets Manager
-   [Vector Express](https://vector.express/) - Vector Converters

### Hosting Tools

-   [censys](https://search.censys.io/) - Domain Info Tools
-   [Check-Host](https://check-host.net/) - Web-Based Uptime Monitors
-   [TLD-List](https://tld-list.com/) - Domain Price Comparisons
...
-   [Awesome-Web-Hosting](https://nuhmanpk.github.io/Awesome-Web-Hosting/) - Free Hosting Provider Index
...
-   [DNSTwist](https://dnstwist.it/) - Typosquatting Checkers
...
-   [HumHub](https://www.humhub.com/) - Self-Hosted Social Network
-   [iana](https://www.iana.org/) - Internet Registry Sites
-   [⁠Instances (Vantage)](https://instances.vantage.sh/) - Compare AWS, Azure, and GCP Instances
-   [InstantDomain](https://instantdomainsearch.com/) - Domains
-   [IPIP.NET](https://whois.ipip.net/) - Country / Region ASNs
-   [Kener](https://kener.ing/) - Self-Hosted Status Pages
-   [Meta Tag Gen](https://lewdev.github.io/apps/meta-tag-gen/) - Meta Tag Generators
-   [MyBB](https://www.mybb.com/) - Forum Hosting
-   [OONI](https://ooni.org/) - Check Site Location Availability
-   [OpenPanel](https://openpanel.com/) - Web Hosting Panels
-   [Oracle Cloud](https://www.oracle.com/cloud/free/) - Free VPS / Requires Real Information / Guide (Important)
...
-   [Sandstorm](https://sandstorm.org/) - Web App Hosts
...
-   [SubDomainizer](https://github.com/nsonaniya2010/SubDomainizer) - Find Hidden Subdomains
-   [UNIT3D](https://github.com/HDInnovations/UNIT3D) - Private Tracker Hosting
-   [Uptime Kuma](https://github.com/louislam/uptime-kuma) - Uptime Monitors
-   [⁠Val Town](https://www.val.town/) - Serverless Scripting and Sharing
-   [vichan](https://vichan.info/) - Imageboard Hosting
-   [VPS Comparison Chart](https://lowendstock.com/deals/) - VPS Comparisons
...
-   [UHostFull.com](https://www.uhostfull.com/) - 5GB Storage / Unlimited Bandwidth / Unlimited DB
...
-   [Cloudflare Pages](https://pages.cloudflare.com/) - 20K Files (25MB Each) / Unlimited
-   [Codeberg Pages](https://codeberg.page/) - 750MB / Unlimited / Only Open-Source Projects / Request Storage
-   [GitHub Pages](https://docs.github.com/en/pages) - 1GB (100MB per File) / 100GB
-   [nekoweb](https://nekoweb.org/) - 500MB, 5K Files / Unlimited
-   [Neocities](https://neocities.org/) - 1GB / 200GB / No Custom Domain
-   [Sourcehut Pages](https://srht.site/) - 1GB / Unlimited
-   [surge](https://surge.sh/) - Unlimited / Unlimited
...
-   [CybersecResources](https://www.cybersources.site/) - Cybersecurity Resources
...
-   [OSCP-Exam-Report-Template-Markdown](https://noraj.github.io/OSCP-Exam-Report-Template-Markdown/) - Offensive Security Exam Report Markdown
...
-   [DNS over HTTPS](https://github.com/curl/curl/wiki/DNS-over-HTTPS) - Encrypted DNS Providers & Resources / Public Servers
...
-   [WebAuthn](https://webauthn.guide/) - Web Authentication API - Demo
...
-   [Hitch](https://www.varnish-software.com/community/hitch) - SSL / TLS Proxy
-   [HTTPToolkit](https://httptoolkit.com/) - Intercept, Debug, and Mock HTTP(S)
-   [Let's Encrypt](https://letsencrypt.org/) - Free TLS Certificates
-   [mitmproxy](https://mitmproxy.org/) - Analyze and modify HTTPS traffic / OpenAPI Converter
...
-   [GHIDRA](https://github.com/NationalSecurityAgency/ghidra) - Reverse Engineering Framework / Plugins
-   [Plugins](https://plugins.hex-rays.com/) - Software Disassembler / Decompiler / Plugins
-   [x64dbg](https://x64dbg.com/) - Debugger for Reverse Engineering / Plugins
...
-   [horsicq](https://horsicq.github.io/) - File Type Identification Tools
...
-   [Radare](https://www.radare.org/n/) - Free Reversing Toolkit
-   [REMnux](https://remnux.org/) - Reverse Engineering / Malware Analysis
-   [⁠Reverse Engineering](https://discord.gg/reverse-engineering-391398885819547652) - Reverse Engineering Community
