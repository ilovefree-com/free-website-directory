...
> Free text editors, note-taking apps, translators, Markdown tools, font resources, and writing tools curated by the FMHY community.

### Text Tools

-   [Goblin.tools](https://goblin.tools/Formalizer/) - Transform Text with Spiciness Levels
-   [SortMyList](https://sortmylist.com/) - Organize / Format Text
-   [⁠Asciify](https://asciify.dev/) - ASCII Character Reference
-   [BeefText](https://beeftext.org/) - Text Substitution Tool
-   [Calligrapher.ai](https://www.calligrapher.ai/) - Text to Handwriting Converters
-   [Count Duplicates](https://www.somacon.com/p568.php) - Count / Remove Duplicates in a List
-   [Diffr](https://loilo.github.io/diffr/) - Compare Text
-   [DocuSeal](https://www.docuseal.com/) - Free Document Signing
-   [OpenPaper](https://openpaper.work/en/) - Document Managers
-   [Scanner](https://simon-knuth.github.io/scanner/index) - Scanner Apps
...
-   [GitHub Gists](https://gist.github.com/) - Multi-Syntax / Requires Sign-Up
-   [Katbin](https://katb.in/) - Plain Text
-   [Markbox](https://markbox.cc/) - Markdown Support / Custom URLs
-   [pastes.dev](https://pastes.dev/) - Multi-Syntax / Markdown Support
-   [PrivateBin](https://privatebin.net/) - Markdown Support / Syntax Highlighting / Instances
-   [Rentry](https://rentry.co/) - Markdown Support / Custom URLs / CLI / Styling
...
-   [cryptgeon](https://cryptgeon.org/) - Single View / Plain Text
...
-   [lesma](https://lesma.eu/) - Multi-Syntax
-   [MarkdownPastebin](https://markdownpastebin.com/) - Markdown Support
-   [⁠Memochō](https://bin.kv2.dev/) - Minimal Pastebins
-   [NoPaste](https://nopaste.boris.sh/) - Multi-Syntax
-   [Opengist](https://opengist.io/) - Self-Hosted Pastebin / GitHub Gists Alt / Demo
-   [Paste](https://paste.boxlabs.uk/) - Multi-Syntax / Markdown Support
...
-   [pastemyst](https://paste.myst.rs/) - Multi-Syntax
...
-   [snowbin](https://pastes.fmhy.net/) - Markdown Support
...
-   [Yasosu](https://yaso.su/) - Multi-Syntax / Markdown Support
...
-   [Translate Web Pages](https://github.com/FilipePS/Traduzir-paginas-web) - Browser Extensions
...
-   [LibreTranslate](https://libretranslate.com/) - FOSS Translator / Self-Hosted / Offline
...
-   [Poedit](https://poedit.net/) - Software Translation
...
-   [Translate Shell](https://www.soimort.org/translate-shell/) - Translation CLI
-   [Translator++](https://dreamsavior.net/) - CAT For Games
...
-   [Revoldiv](https://revoldiv.com/) - AI-Based Transcriptions
-   [SpeechNotes](https://speechnotes.co/) - Speech Recognition Notes App
-   [SpeechTexter](https://www.speechtexter.com/) - Browser-Based Audio Transcription Tools
...
-   [Whisper](https://github.com/openai/whisper) - Audio Transcription / WebUI, 2
...
-   [Chrome](https://chromewebstore.google.com/detail/base64-decode-copy/llcfmnginbnmkeddkjjellcimmffjdcf) - Chrome / Firefox
...
-   [quipqiup](https://www.quipqiup.com/) - Cryptogram Solvers
-   [SearchDecode](https://github.com/bewf/SearchDecode)
-   [StegCloak](https://stegcloak.surge.sh/) - Hide Messages in Text
-   [Universal Encoding Tool](https://unenc.com/) - Encode / Convert Text
-   [URLDecode](https://www.urldecode.org/) - URL Encoding / Decoding
...
-   [Grammarly](https://www.grammarly.com/grammar-check) - Web App / Extension
-   [Harper](https://writewithharper.com/) - Web App / Extension
...
-   [QuillBot](https://quillbot.com/grammar-check) - Web App / Extension / Features
...
-   [Emojipedia](https://emojipedia.org/) - Emoji Indexes
...
-   [emotes.io](https://emotes.io/) - Copy Unicode Emotes
-   [Graphemica](https://graphemica.com/)
-   [Symbol.so](https://symbol.so/)
-   [SymbolSelect](https://www.symbolselect.com/)
-   [Unicode Explorer](https://unicode-explorer.com/) - Unicode Character Identification
-   [Unicode Table](https://symbl.cc/)
-   [Unifoundry](https://unifoundry.com/)

#### Typing Lessons

-   [keybr](https://www.keybr.com/) - Custom Touch Typing Practice
-   [Monkeytype](https://monkeytype.com/) - Custom Touch Typing Tests
-   [10fastfingers](https://10fastfingers.com/) - Typing Competitions
-   [⁠Layouts Wiki](https://layouts.wiki/) - Alt Typing Layouts Wiki
-   [NGram Type](https://ranelpadon.github.io/ngram-type/) - Touch Typing Tests
-   [Typ.ing](https://typ.ing/) - Typing Tests
-   [TypeRacer](https://play.typeracer.com/) - Typing Games
-   [⁠Typersguild](https://typersguild.com/) - Book Typing Tests
...
-   [TypingStudy](https://www.typingstudy.com/) - Multilingual Touch Typing Tests

### Text Editors

-   [Notepad++](https://notepad-plus-plus.org/) - Notepad & Code Editor
...
-   [NotepadNext](https://github.com/dail8859/NotepadNext) - Notepad & Code Editor
-   [Notepads](https://www.notepadsapp.com/) - Text Editor
-   [SciTE](https://www.scintilla.org/SciTE.html) - Text Editor
-   [Sublime Text](https://www.sublimetext.com/) - Text Editor / / Package Manager
...
-   [AnyType](https://anytype.io/) - Note-Taking / E2EE / All Platforms
-   [Notesnook](https://notesnook.com/) - Note-Taking / E2EE / All Platforms +
-   [Obsidian](https://obsidian.md/) - Markdown Note-Taking / All Platforms
-   [Publish Notes](https://dg-docs.ole.dev/) - Publish Notes / Web Clipper / Google Drive Sync / Guides / Forum
-   [AFFiNE](https://affine.pro/) - Note-Taking / All Platforms +
-   [AppFlowy](https://appflowy.com/) - Note-Taking App with Markdown Support
-   [BookStack](https://www.bookstackapp.com/) - Self-Hosted Info Managers
-   [Butterfly](https://butterfly.linwood.dev/) - Handwritten Notes / All Platforms
-   [⁠Crypt.ee](https://crypt.ee/) - Encrypted Notes / E2EE / All Platforms
-   [Desklamp](https://desklamp.io/) - Reading / Note-Taking / Highlighting Tool / / Guide
-   [DocMost](https://docmost.com/) - Note-Taking / Self-Hosted
-   [Flotes](https://flotes.app/) - Markdown Note-Taking
-   [Google Keep](https://keep.google.com/) - Simple Notes / / Chrome
-   [Joplin](https://joplinapp.org/) - Note-Taking / All Platforms / Firefox / Chrome
-   [KeyNote NF](https://github.com/dpradov/keynote-nf) - Note-Taking / E2EE
-   [Logseq](https://logseq.com/) - Outlining
-   [Lokus](https://www.lokusmd.com/) - Markdown Note-Taking
-   [Memos](https://usememos.com/) - Note-Taking / Self-Hosted
-   [MicroPad](https://getmicropad.com/) - Note-Taking / / Web
-   [Mochi Cards](https://mochi.cards/) - Note-Taking / Study Tools / All Platforms
-   [Notion](https://www.notion.com/) - Note-Taking / All Platforms +
-   [Org-roam](https://www.orgroam.com/) - Info Manager / Self-Hosted
-   [Papers.IM](https://papers.im/) - Note-Taking
-   [QOwnNotes](https://www.qownnotes.org/) - Markdown Note-Taking
-   [Resources](https://www.notioneverything.com/notion-world) - Resources, 2 / Guide / Markdown Extractor / Web Clipper
-   [Saber](https://saber.adil.hanney.org/) - Handwritten Notes / All Platforms
-   [SilentNotes](https://www.martinstoeckli.ch/silentnotes/) - Note-Taking / E2EE
-   [Silicon](https://github.com/cu/silicon) - Note-Taking / Self-Hosted
-   [Simplenote](https://simplenote.com/) - Note-Taking / All Platforms
-   [Standard Notes](https://standardnotes.com/) - Encrypted Notes / E2EE / All Platforms / Web
-   [Tiddly](https://tiddlywiki.com/) - Info Manager / / Desktop
-   [Trilium](https://github.com/TriliumNext/Trilium) - Info Manager
-   [vNote](https://app.vnote.fun/en_us/) - Markdown Note-Taking
-   [WriteDown](https://writedown.app/) - Note-Taking
-   [Xournal++](https://xournalpp.github.io/) - Handwritten Notes

#### Office Suites

-   [LibreOffice](https://www.libreoffice.org/) - FOSS Office Suite
-   [Microsoft Office](https://massgrave.dev/office_c2r_links) - Office Suite / Hotkeys / Removal Tool, 2, 3
...
-   [Ziziyi](https://office.ziziyi.com/) - Online Office Suite
...
-   [Leaflet](https://leaflet.pub/) - Cloud Saves / Customizable / Examples
...
-   [markmap](https://markmap.js.org/) - Markdown Mind Mapping
...
-   [⁠Tangent](https://www.tangentnotes.com/) - Markdown Mind Mapping
...
-   [ExcelJet](https://exceljet.net/formulas) - Excel Formulas
-   [Framacalc](https://framacalc.org/) - Collaborative Spreadsheets
...
-   [⁠Proton Sheets](https://proton.me/drive/sheets) - Online Spreadsheet Viewers / CSV Editors
-   [⁠QSV](https://github.com/dathere/qsv) - CSV CLI Toolkits
...
-   [tad](https://github.com/antonycourtney/tad) - Spreadsheet Viewers / CSV Editors
-   [TadViewer](https://www.tadviewer.com/) - View / Analyze Tabular Data
-   [Vertex42](https://www.vertex42.com/) - Excel Templates

#### Writing Tools

-   [Linked](https://uselinked.com/) - Journal Apps
-   [Manuskript](https://www.theologeek.ch/manuskript/) - Writing Organizer / Planner
-   [NovelWriter](https://novelwriter.io/) - Novel Editors
-   [Writer](https://www.gibney.org/writer) - Distraction-Free Writing
-   [Fortelling](https://www.fortelling.app/) - Novel Plotting / Editing Workspaces
-   [Gateway Forge](https://gatewayforge.com/) - Worldbuilding / Story Writing Apps
...
-   [Infinite Story](https://infinite-story.com/) - Collaborative Writing / Feedback
-   [Label Buddy](https://jeromedockes.github.io/labelbuddy/labelbuddy/current/) - Annotation Tool
...
-   [PolyGlot](https://draquet.github.io/PolyGlot/) - Spoken Language Construction Tools
-   [Rarebit](https://rarebit.neocities.org/) - Webcomics Template
-   [RenPy](https://www.renpy.org/) - Visual Novel Editor
-   [rNote](https://rnote.flxzt.net/) - Annotation Tool
-   [STARC](https://starc.app/) - Script / Screen Writing Tools
-   [TextUSM](https://textusm.com/) - User Story Map Generator
-   [Tuesday JS](https://kirill-live.itch.io/tuesday-js) - Visual Novel Editor
...
-   [Microsoft To Do](https://to-do.office.com/) - To-Do Apps
...
-   [ToDo List](https://www.abstractspoon.com/)
...
-   [TAAG](https://patorjk.com/software/taag/) - ASCII Art / Text Generators
-   [AnsiLove](https://www.ansilove.org/downloads.html) - ANSI / ASCII Art to PNG Converters
-   [ASCII Paint](https://ascii.alienmelon.com/) - ASCII Paint Tools
-   [Image to Braille](https://505e06b2.github.io/Image-to-Braille/) - Convert Images to Braille
-   [Love ASCII](http://loveascii.com/) - Browse / Copy ASCII Art
-   [lvllvl](https://lvllvl.com/) - C64 PETSCII Image Editor
-   [REXPaint](https://www.gridsagegames.com/rexpaint/) - ASCII Editors / Drawing
...
-   [Quartz](https://quartz.jzhao.xyz/) - Publish Markdown
...
-   [yq](https://mikefarah.gitbook.io/yq/) - Portable YAML Processor
...
-   [⁠Markpad](https://markpad.sftwr.dev/) - Lightweight / Minimal
...
-   [⁠MathCheap](https://mathcheap.xyz/) - AI-Powered LaTeX Editors
-   [Overleaf](https://www.overleaf.com/)
...
-   [Google Fonts](https://fonts.google.com/) - Commercial Use / Self-Host / Privacy-Friendly API
...
-   [psd\_fonts](https://vk.com/psd_fonts)

### Font Tools

-   [Font Analyzer](https://font-analyzer-six.vercel.app/) - Find Similar Fonts
...
-   [FontBase](https://fontba.se/) - Font Managers
-   [Fonts Ninja](https://fonts.ninja/tools) - Find Similar Fonts / Extensions
...
-   [Type Design Resources](https://typedesignresources.com/) - Typeface Resources
-   [Type Terms](https://avark.agency/typeterms/) - Typography Cheat Sheet

#### Font / Text Generators

-   [FontoGen](https://github.com/SerCeMan/fontogen) - Custom AI Font Generators
-   [Make WordArt](https://www.makewordart.com/) - WordArt Generators / 3D Text
-   [Batname](https://batname.vercel.app/) - Batman (2022) Text Generator
-   [Fast3DText](https://fast3dtext.com/) - Animated / 3D Text Generators
-   [Glitch](https://glitchtextgenerator.com/) - Zalgo Text Generator
-   [NFG's Arcade Font Maker](https://nfggames.com/games/fontmaker/) - Arcade Text Generators
...
-   [Textanim](https://textanim.com/) - Animated Text Generators
...
-   [enFont](https://enfont.javierarce.com/) - Custom Font Creators
-   [FontEdit](https://github.com/ayoy/fontedit) - Font / Typeface Editors
-   [Fontjoy](https://fontjoy.com/) - Generate Font Combinations
-   [FontSprite](https://adamstrange.itch.io/fontsprite) - FontSprite Editor
-   [V-Fonts](https://v-fonts.com/) - Variable Fonts Testers
